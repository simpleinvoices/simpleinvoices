...
{literal}
    ...
    $("#manageGrid").flexigrid ({
        ...
        colModel : [
            ...
            {display: '{/literal}{$LANG.notes}{literal}'     , name : 'ac_notes'   , width : 20 * percentage_width, sortable : true , align: 'left'},
            {display: '{/literal}{$LANG.type}{literal}'      , name : 'description', width : 07 * percentage_width, sortable : true , align: 'left'},
