...
// @formatter:on
$sql = '';
$payments = paymentssql(     '', $dir, $sort, $rp, $page);//, &$sql);
    ...
    $xml .= 
        '<cell><![CDATA[
           <a class="index_table" title="'. $LANG['view']. ' '. $row['index_name']. '" 
             ...
             <img src="images/common/view.png" alt="view" /><!-- height="16" border="-5px" padding="-4px" valign="bottom"-->
           </a>
           <a class="index_table" title="'. $LANG['print_preview_tooltip']. ' '. $row['id']. '" 
              href="index.php?module=payments&view=print&id='. $row['id']. '">
             <img src="images/common/printer.png" alt="print" /><!--height="16" border="-5px" padding="-4px" valign="bottom"-->
           </a>
         ]]></cell>';
