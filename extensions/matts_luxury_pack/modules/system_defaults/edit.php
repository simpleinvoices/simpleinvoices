<?php
/* extensions/product_add_LxWxH_weight/modules/system_defaults/edit.php */
...
/**/
	...
	$array = array($LANG['disabled'], $LANG['enabled']);
	$default = "price_list";
	$description = $LANG['price_list'];
	$value = dropDown($array, $defaults[$default]);
}
else if ($_GET['submit'] == "use_modal") {
...
else if ($_GET['submit'] == "use_ship_to") {
