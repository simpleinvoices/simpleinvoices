...
//require ('./extensions/invoice_add_display_no/lang/en_CA');
/**/
class export2
{
	public $format;
...
//					echo '<script>alert("wasid='. $this->id. 'newid='.$master_invoice['id']. 'sql='.$sql.'|master_invoice='. print_r ($master_invoice, true). '")</script>';
