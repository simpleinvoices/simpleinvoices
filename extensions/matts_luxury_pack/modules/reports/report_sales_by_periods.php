...
while ( $year <= $this_year ){
	...
	while ($month <= 12){
		...
		if (isset($data['sales']['months_rate'][$month][$year]))	$data['sales']['months_rate'][$month][$year] = _myRate($data['sales']['months'][$month][$year],	$data['sales']['months'][$month][$year -1]);
		...
		if (isset($data['payments']['months_rate'][$month][$year]))	$data['payments']['months_rate'][$month][$year] = _myRate($data['payments']['months'][$month][$year],	$data['payments']['months'][$month][$year -1]);
	...
	if (isset($data['sales']['total_rate'][$year]))	$data['sales']['total_rate'][$year] = _myRate($data['sales']['total'][$year],	$data['sales']['total'][$year -1]);
	...
	if (isset($data['payments']['total_rate'][$year]))	$data['payments']['total_rate'][$year]		= _myRate($data['payments']['total'][$year],	$data['payments']['total'][$year -1]);
