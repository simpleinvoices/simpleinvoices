...
{literal}
    ...
    $("#manageGrid").flexigrid ({
        ...
        colModel : [
            ...
            {display: '{/literal}{$LANG.invoice}{literal}',		name : 'ap.ac_inv_id',	width : 10 * percentage_width,	sortable : true,	align: 'left'},
            ...
            {display: '{/literal}{$LANG.amount}{literal}',		name : 'ap.ac_amount',	width : 10 * percentage_width,	sortable : true,	align: 'right'},
            ...
            {display: '{/literal}{$LANG.date_upper}{literal}',	name : 'ap.date',		width : 10 * percentage_width,	sortable : true,	align: 'center'}
        ],
        searchitems : [
            {display: '{/literal}{$LANG.id}{literal}',			name : 'id'},
			{display: '{/literal}{$LANG.invoice}{literal}',		name : 'index_id',	isdefault: true},
            {display: '{/literal}{$LANG.biller}{literal}',		name : 'bname'},
            {display: '{/literal}{$LANG.customer}{literal}',	name : 'cname'}
        ],
