...
if ($_POST['action'] == "register") {
  ...
  $sth = dbQuery($sql, ':name',$_POST['name'],':description',$_POST['description'],':domain_id', $auth_session->domain_id) or die(htmlspecialchars(end($dbh->errorInfo())));
  ...
  $sth = dbQuery($sql, ':id', $_POST['id']) or die(htmlspecialchars(end($dbh->errorInfo())));
