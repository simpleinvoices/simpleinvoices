...
<form name="frmpost" action="index.php?module=products&amp;view=add" method="post">
  ...
  <table>
    <tr>
      ...
      <td>
        <input type="text" name="description" value="{$smarty.post.description}" size="20" />
      </td>
    </tr>
    <tr>
      <td class="details_screen">{$LANG.product_unit_price}</td>
      <td>
        <input type="text" name="unit_price" value="{$smarty.post.unit_price}"  size="10" />
      </td>
    </tr>
    <tr>
      <td class="details_screen">{$customFieldLabel.product_cf1}</td>
      <td>
        <input type="text" name="custom_field1" value="{$smarty.post.custom_field1}"  size="20" />
      </td>
    </tr>
    <tr>
      <td class="details_screen">{$customFieldLabel.product_cf2}</td>
      <td>
        <input type="text" name="custom_field2" value="{$smarty.post.custom_field2}" size="20" />
      </td>
    </tr>
    <tr>
      <td class="details_screen">{$customFieldLabel.product_cf3}</td>
      <td>
        <input type="text" name="custom_field3" value="{$smarty.post.custom_field3}" size="20" />
      </td>
    </tr>
    <tr>
      <td class="details_screen">{$customFieldLabel.product_cf4}</td>
      <td>
        <input type="text" name="custom_field4" value="{$smarty.post.custom_field4}" size="20" />
      </td>
    </tr>
    <tr>
