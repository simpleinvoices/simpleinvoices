...
@if($smarty.get.action== 'view' )
	...
	<td>
            @foreach(from=$attributes item=attribute)
                @if($matrix1.attribute_id == $attribute.id){{ $attribute['name'] }}@endif
            @endforeach
		</td>
	</tr>
	<tr>
		...
		<td>
            @foreach(from=$attributes item=attribute)
                @if($matrix2.attribute_id == $attribute.id){{ $attribute['name'] }}@endif
            @endforeach
		</td>
	</tr>
	<tr>
		...
		<td>
            @foreach(from=$attributes item=attribute)
                @if($matrix3.attribute_id == $attribute.id){{ $attribute['name'] }}@endif
            @endforeach
		</td>
	</tr>
	<tr>
...
@if($smarty.get.action== 'edit' )
	...
	<tr>
		...
		<td>
		     ...
		     <option value=""></option>
            @foreach(from=$attributes item=attribute)
                <option @if($matrix1.attribute_id == $attribute.id) selected@endif   value="{{ $attribute['id'] }}">{{ $attribute['name'] }}</option>
            @endforeach
            </select>
		</td>
	</tr>
	<tr>
		...
		<td>
		     ...
		     <option value=""></option>
            @foreach(from=$attributes item=attribute)
                <option @if($matrix2.attribute_id == $attribute.id) selected@endif   value="{{ $attribute['id'] }}">{{ $attribute['name'] }}</option>
            @endforeach
            </select>
		</td>
	</tr>
	<tr>
		...
		<td>
		     ...
		     <option value=""></option>
            @foreach(from=$attributes item=attribute)
                <option @if($matrix3.attribute_id == $attribute.id) selected@endif   value="{{ $attribute['id'] }}">{{ $attribute['name'] }}</option>
            @endforeach
            </select>
		</td>
	</tr>
