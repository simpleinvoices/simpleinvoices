...
@else
	...
	@foreach(from=$taxes item=tax)
		<option @if($tax.tax_id == $invoiceItems.0.tax_id) selected @endif value="{{ $tax['tax_id'] }}">{{ $tax['tax_description'] }}</option>
	@endforeach
	</select>
@endif
...
@else
	...
	@foreach(from=$preferences item=preference)
		<option @if($preference.pref_id == $invoice.preference_id) selected @endif value="{{ $preference['pref_id'] }}">{{ $preference['pref_description'] }}</option>
	@endforeach
	</select>
@endif
