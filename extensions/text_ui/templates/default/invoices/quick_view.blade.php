...
@foreach(from=$invoiceItems item=invoiceItem )
		...
		@if($invoice.type_id == 2 || $invoice.type_id == 4)
			...
			<tr>
					...
					<td colspan="3">{$invoiceItem.product.description} @if($invoiceItem.attr1.display != "" ) ::@endif {$invoiceItem.attr1.display}  {$invoiceItem.attr2.display} {$invoiceItem.attr3.display}</td>
			</tr>
			<tr>
