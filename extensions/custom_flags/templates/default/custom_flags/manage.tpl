...
{else}
  <div id="Container" class="col si_wrap">
    ...
    <div class="si_help_div">
      <a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_what_are_custom_flags"
        title="{$LANG.what_are_custom_flags}">{$LANG.what_are_custom_flags}
        <img src="{$help_image_path}help-small.png" alt="" />
      </a>
      ::
      <a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_manage_custom_flags"
