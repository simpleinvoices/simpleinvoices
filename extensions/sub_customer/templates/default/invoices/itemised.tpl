...
<form name="frmpost" action="index.php?module=invoices&amp;view=save" method="post"
    ...
    {if $first_run_wizard == true}
        ...
        <br />
    {else}
        {* header.tpl ends with open tags for <table><tr><td> *}
                                        ...
                                        <tr>
                                            ...
                                            {else}
                                                <select id="products{$smarty.section.line.index|htmlsafe}"
                                                    ...
                                                    {foreach from=$products item=product}
                                                        <option value="{if $product.id == $smarty.get.product.$lineNumber}
                                                                           {$smarty.get.product.$lineNumber}" selected
                                                                       {else}
                                                                           {$product.id|htmlsafe}"
                                                                       {/if}" >
                                                ...
                                                <td>
                                                    <select id="tax_id[{$smarty.section.line.index|htmlsafe}][{$smarty.section.tax.index|htmlsafe}]"
                                                        ...
                                                        {foreach from=$taxes item=tax}
                                                            <option value="{if $tax.tax_id == $smarty.get.tax.$lineNumber.$taxNumber}
                                                                               {$smarty.get.tax.$lineNumber.$taxNumber}" selected
                                                                           {else}
                                                                               {$tax.tax_id|htmlsafe}"
                                                                           {/if} >
                                            ...
                                            <td>
                                                <input id="unit_price{$smarty.section.line.index|htmlsafe}" 
                                                       ...
                                                       value="{if $smarty.get.unit_price.$lineNumber}
                                                                  {$smarty.get.unit_price.$lineNumber}
                                                              {/if}"
                                                      {if $smarty.section.line.index == "0"}
                                        ...
                                        <tr class="note">
                                            ...
                                            <td colspan="4">
                                                <textarea class="editor"
                                                          name="description{$smarty.section.line.index|htmlsafe}"
                                                          id="description{$smarty.section.line.index|htmlsafe}"
                                                          rows="3" cols="50">
                                                </textarea>
                                            </td>
                                        </tr>
