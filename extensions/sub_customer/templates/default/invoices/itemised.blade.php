		...
		<table id="itemtable">
			...
			<tr>
				...
				{section name=tax_header loop=$defaults.tax_per_line_item }
					<td class="details_screen">{{ $LANG['tax'] ?? '' }} @if($defaults.tax_per_line_item > 1){$smarty.section.tax_header.index+1|htmlsafe}@endif </td>
				{/section}
				...
				<tbody class="line_item" id="row{$smarty.section.line.index|htmlsafe}">
					...
					@else
						<select 
							...
							rel="{$smarty.section.line.index|htmlsafe}"
							class="@if($smarty.section.line.index == "0")validate[required]@endif product_change"						
                        >
							<option value=""></option>
						...
						<td>
							<input 
								...
								@else
								   value=""
								@endif
                                @if($smarty.section.line.index == "0") class="validate[required]" @endif
							/>
						</td>	
					</tr>
