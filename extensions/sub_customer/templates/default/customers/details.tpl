...
<form name="frmpost"
  ...
  <tr>
    ...
    <td>
      <input type="text" name="credit_card_holder_name"
             value="{$customer.credit_card_holder_name|htmlsafe}" size="25" tabindex="120" />
    </td>
  </tr>
  <tr>
    <td class="details_screen">{$LANG.credit_card_number}</td>
  ...
  <tr>
    ...
    <td>
      <input type="text" name="credit_card_number_new"
             value="{$customer.credit_card_holder_name_new|htmlsafe}" size="25" tabindex="130" />
    </td>
  </tr>
  <tr>
    <td class="details_screen">{$LANG.credit_card_expiry_month}</td>
    <td>
      <input type="text" name="credit_card_expiry_month"
             value="{$customer.credit_card_expiry_month|htmlsafe}" size="5" tabindex="140" />
    </td>
  </tr>
  <tr>
    <td class="details_screen">{$LANG.credit_card_expiry_year}</td>
    <td>
      <input type="text" name="credit_card_expiry_year"
             value="{$customer.credit_card_expiry_year|htmlsafe}" size="5" tabindex="150" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      <input type="text" name="custom_field1" value="{$customer.custom_field1|htmlsafe}"
             size="50" tabindex="170" />
    </td>
  </tr>
  <tr>
    <td class="details_screen">{$customFieldLabel.customer_cf2|htmlsafe}
    ...
    <td>
      <input type="text" name="custom_field2" value="{$customer.custom_field2|htmlsafe}"
             size="50" tabindex="180" />
    </td>
  </tr>
  <tr>
    <td class="details_screen">{$customFieldLabel.customer_cf3|htmlsafe} 
    ...
    <td>
      <input type="text" name="custom_field3" value="{$customer.custom_field3|htmlsafe}"
             size="50" tabindex="190" />
    </td >
  </tr>
  <tr>
    <td class="details_screen">{$customFieldLabel.customer_cf4|htmlsafe}
    ...
    <td>
      <input type="text" name="custom_field4" value="{$customer.custom_field4|htmlsafe}"
             size="50" tabindex="200" />
    </td>
  </tr>
  <tr>
