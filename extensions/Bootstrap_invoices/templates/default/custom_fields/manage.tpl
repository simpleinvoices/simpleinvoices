...
*/
*}
	<h1 class="title">{$LANG.custom_fields_upper}</h1>
{if $cfs == null}
...
<div class="si_help_div">
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_what_are_custom_fields" title="{$LANG.what_are_custom_fields}">{$LANG.what_are_custom_fields}<span class="glyphicon glyphicon-question-sign"></span></a> ::
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_manage_custom_fields" title="{$LANG.whats_this_page_about}">{$LANG.whats_this_page_about}<span class="glyphicon glyphicon-question-sign"></span></a>
</div>
