	...
	<table class="buttons" align="center">
		<tr>
			<td>
				...
				<img src="{$baseUrl}sys/images/famfam/report_edit.png" alt="" />{$LANG.edit}</a>

            <a href="./index.php?module=preferences&amp;view=manage" class="negative">
				<img src="{$baseUrl}sys/images/common/cross.png" alt="" />{$LANG.cancel}</a>
			</td>
		</tr>
	</table>
	<br />
	<table  align="center">
		<tr>
			<td colspan="2" align="center" class="align_center">
				...
				<img src="{$baseUrl}sys/images/common/help-small.png" alt="" /> Whats all this "Invoice Preference" stuff about? </a>
			</td>
		</tr>
	</table>
...
<br />
	<table align="center">
		...
		<tr>
			<td colspan="2" align="center" class="align_center">
				<a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_what_the" title="{$LANG.whats_all_this_inv_pref}">
				<img src="{$baseUrl}sys/images/common/help-small.png" alt="" /> {$LANG.whats_all_this_inv_pref} </a>
			</td>
		</tr>
	</table>
<br />
