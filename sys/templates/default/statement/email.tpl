...
<form name="frmpost" action="index.php?module=statement&amp;view=email&amp;stage=2&amp;biller_id={$smarty.get.biller_id|urlencode}&amp;customer_id={$smarty.get.customer_id|urlencode}&amp;start_date={$smarty.get.start_date|urlencode}&amp;end_date={$smarty.get.end_date|urlencode}&amp;show_only_unpaid={$smarty.get.show_only_unpaid|urlencode}&amp;format=file&amp;filter_by_date={$smarty.get.filter_by_date|urlencode}" method="post">
<div id="top"><h3>{$LANG.email_statement_as_pdf}</h3></div>

<table align="center">
	<tr>
		<td class="details_screen">{$LANG.email_from}
		<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_email_from" title="{$LANG.email_from}"><img src="{$include_dir}sys/images/common/help-small.png" alt="" /></a>
		</td>
		<td><input type="text" name="email_from" size="50" value="{$biller.email|htmlsafe}" /></td>
	</tr>
	<tr>
		<td class="details_screen">{$LANG.email_to}
		<a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_email_to" title="{$LANG.email_to}"><img src="{$include_dir}sys/images/common/help-small.png" alt="" /></a>
		</td>
		<td><input type="text" name="email_to" size="50" value="{$customer.email|htmlsafe}" /></td>
	</tr>
	<tr>
	<td class="details_screen">{$LANG.email_bcc}
		<a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_email_bcc" title="{$LANG.email_bcc}"><img src="{$include_dir}sys/images/common/help-small.png" alt="" /></a>
		</td>
