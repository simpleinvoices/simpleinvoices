...
{literal}
	...
	<script type="text/javascript" src="{/literal}{$include_dir}{literal}sys/include/jquery/jquery.init.js"></script>

	<link rel="stylesheet" type="text/css" href="{/literal}{$include_dir}{literal}sys/templates/default/css/jquery-ui/default/default.dialog.css" media="all" />
	<link rel="stylesheet" type="text/css" href="{/literal}{$include_dir}{literal}sys/templates/default/css/print.css" media="print" />
	<!-- jQuery Files -->
	<script type="text/javascript" src="{/literal}{$include_dir}{literal}sys/include/jquery/jquery-ui-personalized-1.6rc2.packed.js"></script>	
	...
	<link rel="stylesheet" type="text/css" href="{/literal}{$include_dir}{literal}sys/templates/default/css/jquery-ui/tab.css" media="all" />
	<!--[if IE]>
	...
	<link rel="stylesheet" type="text/css" href="{/literal}{$include_dir}{literal}sys/include/jquery/rte/rte.css" />	
