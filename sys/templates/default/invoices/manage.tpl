		...
		<table class="buttons">
			<tr>
				<td>
					...
					>
						<img src="{$smarty_embed_pathx}sys/images/common/page_white_acrobat.png" alt="" />
						{$LANG.export_pdf}
					</a>
				  </td>
			</tr>
			<tr>
				<td>  
				   ...
				   >
						<img src="{$smarty_embed_pathx}sys/images/common/page_white_excel.png" alt="" />
						{$LANG.export_xls}
					</a>
					</td>
			</tr>
			<tr>
				<td>    
				   ...
				   >
						<img src="{$smarty_embed_pathx}sys/images/common/page_white_word.png" alt="" />
						{$LANG.export_doc}
					</a>
				</td>
			</tr>
