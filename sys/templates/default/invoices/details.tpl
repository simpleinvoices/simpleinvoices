...
{if $invoice.type_id == 2 || $invoice.type_id == 3 }
		...
		<table id="itemtable">
			<tr>
	        	...
	        	<td>
					...
					>
						<img src="{$smarty_embed_path}/sys/images/common/page_white_add.png" title="{$LANG.show_details}" alt="" />
					</a>
					<a href='#' class="note" onclick="javascript: $('.note').hide();$('.show-note').show();">
						<img src="{$smarty_embed_path}/sys/images/common/page_white_delete.png" title="{$LANG.hide_details}" alt="" />
					</a>
				</td>
		    </tr>
			        ...
			        <tr>
						...
						{if $line != "0"}
							<a 
								...
								rel="{$line|htmlsafe}"
							>
								<img id="delete_image{$line|htmlsafe}" src="{$smarty_embed_path}/sys/images/common/delete_item.png" alt="" />
							</a>
						{/if}
						{if $line == "0"}
							<a 
								...
								rel="{$line|htmlsafe}"
							>
								<img id="delete_image{$line|htmlsafe}" src="{$smarty_embed_path}/sys/images/common/blank.gif" alt="" />
							</a>
						{/if}
						</td>
						<td>
		...
		{*
			<tr>
				<td>
					<a href="./index.php?module=invoices&amp;view=add_invoice_item&amp;invoice={$invoice.id|urlencode}&amp;type={$invoice.type_id|urlencode}&amp;tax_id={$invoiceItems.0.tax_id|urlencode}"><img src="{$smarty_embed_path}/sys/images/common/famfamAdd.png" alt="" />{$LANG.add_invoice_item}</a>
				</td>
				<td>
				</td>
			</tr>
