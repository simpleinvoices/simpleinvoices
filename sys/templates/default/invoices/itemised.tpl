...
<div id="gmail_loading" class="gmailLoader" style="float:right; display: none;">
        	<img src="{$include_dir}sys/images/common/gmail-loader.gif" alt="{$LANG.loading} ..." /> {$LANG.loading} ...
</div>
        ...
        <tr>
                ...
                <td>
                    <a href="./index.php?module=billers&amp;view=add" class="positive">
                        <img src="{$include_dir}sys/images/common/user_add.png" alt="" />
                        {$LANG.add_new_biller}
                    </a>
                </td>
        </tr>
            ...
            <tr>
                ...
                <td>
                    <a href="index.php?module=tax_rates&amp;view=add" class="positive">
                        <img src="{$include_dir}sys/images/common/money_delete.png" alt="" />
...
<table align="left">
						...
						<td>
							...
							>
								<img 
									...
									src="{$include_dir}sys/images/common/blank.gif"
									height="16px"
									width="16px"
							...
							>
								<img src="{$include_dir}sys/images/common/delete_item.png" alt="" />
							</a>
							{/if}
						</td>
						<td>
			...
			<table class="buttons" align="left">
				<tr>
					...
					<a href='#' class="show-note" onclick="javascript: $('.note').show();$('.show-note').hide();">
						<img src="{$include_dir}sys/images/common/page_white_add.png" title="{$LANG.show_details}" alt="" />{$LANG.show_details}</a>
					<a href='#' class="note" onclick="javascript: $('.note').hide();$('.show-note').show();">
						<img src="{$include_dir}sys/images/common/page_white_delete.png" title="{$LANG.hide_details}" alt="" />{$LANG.hide_details}</a>
					</td>
				</tr>
		 </table>
		</td>
	...
	{else}
		...
		{foreach from=$preferences item=preference}
			<option 
                {if $preference.pref_id == $defaults.preference} selected {/if} 
