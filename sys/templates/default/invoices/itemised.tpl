        ...
        <tr>
                ...
                <td>
                    <a href="./index.php?module=billers&amp;view=add" class="positive">
                        <img src="{$smarty_embed_pathx}sys/images/common/user_add.png" alt="" />
                        {$LANG.add_new_biller}
                    </a>
                </td>
        </tr>
            ...
            <tr>
                ...
                <td>
                    <a href="./index.php?module=customers&amp;view=add" class="positive">
                        <img src="{$smarty_embed_pathx}sys/images/common/vcard_add.png" alt="" />
                        {$LANG.customer_add}
                    </a>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <a href="./index.php?module=products&amp;view=add" class="positive">
                        <img src="{$smarty_embed_pathx}sys/images/common/cart_add.png" alt="" />
            ...
            <tr>
                ...
                <td>
                    <a href="index.php?module=tax_rates&amp;view=add" class="positive">
                        <img src="{$smarty_embed_pathx}sys/images/common/money_delete.png" alt="" />
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="./index.php?module=preferences&amp;view=add" class="positive">
                        <img src="{$smarty_embed_pathx}sys/images/common/page_white_edit.png" alt="" />
...
<table align="left">
						...
						<td>
							...
							>
								<img 
									...
									src="{$smarty_embed_pathx}sys/images/common/blank.gif"
									height="16px"
									width="16px"
							...
							>
								<img src="{$smarty_embed_pathx}sys/images/common/delete_item.png" alt="" />
							</a>
							{/if}
						</td>
						<td>
			...
			<table class="buttons" align="left">
				<tr>
					<td>
						...
						>
							<img 
								src="{$smarty_embed_pathx}sys/images/common/add.png"
								alt=""
							/>
							{$LANG.add_new_row}
						</a>
					...
					<a href='#' class="show-note" onclick="javascript: $('.note').show();$('.show-note').hide();">
						<img src="{$smarty_embed_pathx}sys/images/common/page_white_add.png" title="{$LANG.show_details}" alt="" />{$LANG.show_details}</a>
					<a href='#' class="note" onclick="javascript: $('.note').hide();$('.show-note').show();">
						<img src="{$smarty_embed_pathx}sys/images/common/page_white_delete.png" title="{$LANG.hide_details}" alt="" />{$LANG.hide_details}</a>
					</td>
				</tr>
		 </table>
		</td>
	...
	<tr>
		<td class=""> 
			<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_invoice_custom_fields" title="{$LANG.want_more_fields}"><img src="{$smarty_embed_pathx}sys/images/common/help-small.png" alt="" /> {$LANG.want_more_fields}</a>
		</td>
	</tr>
