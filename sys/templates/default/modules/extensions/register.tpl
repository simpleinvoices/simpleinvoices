...
<table>
 <tr>
  ...
  <td><button type="submit" class="positive" name="submit" value="{$LANG.save}">
	<img class="button_img" src="{$baseUrl}images/common/tick.png" alt="{$LANG.save}" />{$LANG.save}
      </button></td>
  <td><a href="./index.php?module=extensions&view=manage" class="negative">
	<img src="{$baseUrl}images/common/cross.png" alt="{$LANG.cancel}" />{$LANG.cancel}</a></td>
 </tr>
</table>
