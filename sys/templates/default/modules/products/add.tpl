...
<table align="center">
	<tr>
		...
		<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_required_field" title="{$LANG.Required_Field}"><img src="{$baseUrl}images/common/required-small.png" alt="" /></a>
		</td>
	...
	<tr>
		...
		<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_custom_fields" title="{$LANG.custom_fields}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a>
		</td>
