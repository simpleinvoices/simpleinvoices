...
<br />
	...
	<tr>
		...
		<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_product_detail" title="{$LANG.details}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a>
