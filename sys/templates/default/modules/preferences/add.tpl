...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_description" title="{$LANG.description}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_currency_sign" title="{$LANG.currency_sign}"><img src="{$baseUrl}images/common/help-small.png" alt="" /> </a>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_currency_code" title="{$LANG.currency_code}"><img src="{$baseUrl}images/common/help-small.png" alt="" /> </a>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_invoice_heading" title="{$LANG.invoice_heading}"><img src="{$baseUrl}images/common/help-small.png" alt="" /> </a>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_invoice_wording" title="{$LANG.invoice_wording}"><img src="{$baseUrl}images/common/help-small.png" alt="" /> </a>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_invoice_detail_heading" title="{$LANG.invoice_detail_heading}"><img src="{$baseUrl}images/common/help-small.png" alt="" /> </a>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_invoice_detail_line" title="{$LANG.invoice_detail_line}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a></td>
	</td>
	<td>
	<input type="text" name="p_inv_detail_line"  value="{$smarty.post.p_inv_detail_line|htmlsafe}" size="75" />
		...
		<tr>
			<td class="details_screen">{$LANG.include_online_payment}
				...
				<img src="{$baseUrl}images/common/help-small.png" alt="" /></a></td>
			<td>
...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_invoice_payment_method" title="{$LANG.invoice_payment_method}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a></td>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_payment_line1_name" title="{$LANG.invoice_payment_line_1_name}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a></td>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_payment_line1_value" title="{$LANG.invoice_payment_line_1_value}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_payment_line2_name" title="{$LANG.invoice_payment_line_2_name}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a>
	</td>
	<td>
...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_payment_line2_value" title="{$LANG.invoice_payment_line_2_value}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a>
	</td>
	<td>
	...
	<tr>
		<td class="details_screen">{$LANG.status}
			<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_status" title="{$LANG.status}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a>
		</td>
		<td>
			<select name="status">
	...
	<tr>
		<td class="details_screen">{$LANG.enabled}
			<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_inv_pref_invoice_enabled" title="{$LANG.enabled}"><img src="{$baseUrl}images/common/help-small.png" alt="" /></a>
		</td>
		<td>
