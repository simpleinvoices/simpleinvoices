...
<br />
    ...
    <span class="welcome">
      <a href="index.php?module=invoices&amp;view=itemised"><img class="action" src="{$baseUrl}images/common/edit.png"/>&nbsp;{$LANG.itemised_style}</a>
			 &nbsp;&nbsp;
       <a href="index.php?module=invoices&amp;view=total"><img class="action" src="{$baseUrl}images/common/page_white_edit.png"/>&nbsp;{$LANG.total_style}</a>
			 &nbsp;&nbsp;
	   <a class="cluetip" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_invoice_types" title="{$LANG.invoice_type}">
			<img class="action" src="{$baseUrl}images/common/help-small.png" alt="" />
	   </a>
    </span>
<br />
<br />
