...
Ext.onReady(function(){
	...
	function renderActions(value, p, record){
		...
		'<!--0 Quick View --><a class="index_table" title="'+ quick_view_tooltip +'" href="index.php?module=invoices&amp;view=quick_view&amp;invoice={1}"> <img src="{$baseUrl}images/common/view.png" height="16" border="-5px" padding="-4px" valign="bottom" alt="" /></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
		...
		'<!--1 Edit View --><a class="index_table" title="'+ edit_view_tooltip +'" href="index.php?module=invoices&amp;view=details&amp;invoice={1}&amp;action=view"><img src="{$baseUrl}images/common/edit.png" height="16" border="-5px" padding="-4px" valign="bottom" alt="" /><!-- print --></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
		...
		'<!--2 Print View --><a class="index_table" title="'+ print_preview_tooltip +'" href="index.php?module=invoices&amp;view=templates/template&amp;invoice={1}&amp;action=view&amp;location=print"><img src="{$baseUrl}images/common/printer.png" height="16" border="-5px" padding="-4px" valign="bottom" alt="" /><!-- print --></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
		...
		'<!--3 EXPORT TO PDF --><a title="'+export_tooltip+'"	class="index_table" href="pdfmaker.php?id={1}"><img src="{$baseUrl}images/common/page_white_acrobat.png" height="16" padding="-4px" border="-5px" valign="bottom" alt="" /><!-- pdf --></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
		...
		'<!--4 XLS --><a title="'+ export_xls_tooltip +'" class="index_table" href="index.php?module=invoices&amp;view=templates/template&amp;invoice={1}&amp;action=view&amp;location=print&amp;export={$spreadsheet|urlencode}"><img src="{$baseUrl}images/common/page_white_excel.png" height="16" border="0" padding="-4px" valign="bottom" alt="" /><!-- $spreadsheet --></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
		...
		'<!--5 DOC --><a title="'+ export_word_tooltip +'" class="index_table" href="index.php?module=invoices&amp;view=templates/template&amp;invoice={1}&amp;action=view&amp;location=print&amp;export={$word_processor|urlencode}"><img src="{$baseUrl}images/common/page_white_word.png" height="16" border="0" padding="-4px" valign="bottom" alt="" /><!-- $word_processor --></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
		...
		'<!--6 Payment --><a title="'+ process_payment_tooltip +'" class="index_table" href="index.php?module=payments&amp;view=process&amp;invoice={1}&amp;op=pay_selected_invoice"><img src="{$baseUrl}images/common/money_dollar.png" height="16" border="0" padding="-4px" valign="bottom" alt="" /></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
		...
		'<!--7 Email --><a href="index.php?module=invoices&amp;view=email&amp;stage=1&amp;invoice={1}" title="'+ email_tooltip +'"><img src="{$baseUrl}images/common/mail-message-new.png" height="16" border="0" padding="-4px" valign="bottom" alt="" /></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
