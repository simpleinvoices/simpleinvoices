...
<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_wheres_the_edit_button" title="{$LANG.wheres_the_edit_button}"><img src="{$baseUrl}sys/images/common/help-small.png" alt="" /> {$LANG.wheres_the_edit_button}</a>
</div>
