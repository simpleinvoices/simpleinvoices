{if $mysql < 5 && $db_server == 'mysql'}
		...
		{$LANG.note} <a href='index.php?module=documentation&amp;view=view&amp;page=help_mysql4' rel='gb_page_center[450, 450]' ><img src='{$include_dir}sys/images/common/help-small.png' alt="" /></a> : {$LANG.mysql4_features_disabled}<br />
{/if}
...
<br />
    ...
    <br />
        ...
        <tr>
            ...
            <img src="{$include_dir}sys/images/common/cog_edit.png" alt=""/>
            {$LANG.settings}
            </a>
            </td>
        </tr>
