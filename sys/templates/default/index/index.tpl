{if $mysql < 5 && $db_server == 'mysql'}
		...
		{$LANG.note} <a href='index.php?module=documentation&amp;view=view&amp;page=help_mysql4' rel='gb_page_center[450, 450]' ><img src='{$smarty_embed_pathx}sys/images/common/help-small.png' alt="" /></a> : {$LANG.mysql4_features_disabled}<br />
{/if}
...
<br />
    ...
    <br />
        ...
        <tr>
            ...
            <img src="{$smarty_embed_pathx}sys/images/common/cog_edit.png" alt=""/>
            {$LANG.settings}
            </a>
            </td>
        </tr>
...
{else}
    ...
    <div>
        ...
        <tr>
            <td>
            <a href="index.php?module=invoices&amp;view=itemised" class="positive">
            <img src="{$smarty_embed_pathx}sys/images/common/add.png" alt=""/>
