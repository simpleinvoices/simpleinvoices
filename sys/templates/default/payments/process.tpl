...
<tr>
	...
	<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_process_payment_auto_amount" title="{$LANG.process_payment_auto_amount}"><img src="{$smarty_embed_path}/sys/images/common/help-small.png" alt="" /></a>
	</td>
</tr>
<tr>
