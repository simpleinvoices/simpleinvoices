...
{if $smarty.get.action == "edit"}
	...
	<table align="center">
	<tr>
		<td class="details_screen">{$LANG.description} <a href="index.php?module=documentation&amp;view=view&amp;page=help_required_field" rel="gb_page_center[350, 150]"><img src="../sys/images/common/required-small.png" alt="(required)" /></a></td>
		<td>
