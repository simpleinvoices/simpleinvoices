...
include($include_dir . 'sys/include/sql_patches.php');
...
function listPatches() {
	...
	<tr>
		...
		<br />
		<img src="../sys/images/common/important.png" alt="" /><font color="red">Warning: Please backup your database before upgrading!</font>
		<br />
		<br />
<table align="center">
EOD;
