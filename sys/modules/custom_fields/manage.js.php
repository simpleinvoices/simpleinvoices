...
*/
			...
			colModel : [
				...
				{display: '{/literal}{$LANG.custom_field}{literal}', name : 'cf_custom_field', width : 30 * percentage_width, sortable : false, align: 'left'},
				{display: '{/literal}{$LANG.custom_label}{literal}', name : 'cf_custom_labei', width : 30 * percentage_width, sortable : false, align: 'left'},
				{display: '{/literal}{$LANG.custom_display}{literal}', name : 'cf_display', width : 20 * percentage_width, sortable : false, align: 'left'}
