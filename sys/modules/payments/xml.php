...
*/
	...
	foreach ($payments as $row) {
		...
		$xml .= "<row id='".$row['id']."'>";
	$xml .= "<cell><![CDATA[
	<a class='index_table' title='$LANG[view] ".$row['bname']."' href='index.php?module=payments&view=details&id=$row[id]&action=view'><img src='" . $baseUrl . "images/common/view.png' height='16' border='-5px' padding='-4px' valign='bottom' /></a>
	<a class='index_table' title='$LANG[print_preview_tooltip] ".$row['id']."' href='index.php?module=payments&view=print&id=$row[id]' target='_blank'><img src='" . $baseUrl . "images/common/printer.png' height='16' border='-5px' padding='-4px' valign='bottom' /></a>
	<a class='index_table' title='$LANG[print_preview_tooltip] ".$row['id']."' href='index.php?module=export&view=payment&id=$row[id]&format=pdf'><img src='images/common/page_white_acrobat.png' height='16' border='-5px' padding='-4px' valign='bottom' /></a>
<!--
	<a title='".$LANG['export_tooltip']." ".$row['preference']." ".$row['id']."' class='index_table' href='index.php?module=export&view=payment&id=$row[id]&format=pdf'><img src='" . $baseUrl . "images/common/page_white_acrobat.png' class='action' /></a>-->
	]]></cell>";
