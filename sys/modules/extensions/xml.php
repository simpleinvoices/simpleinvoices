...
$plugin[0] = " <img src='$baseUrl/images/famfam/plugin_disabled.png' alt='".$LANG['plugin_not_registered']."' />";
$plugin[1] = " <img src='$baseUrl/images/famfam/plugin.png' alt='".$LANG['plugin_registered']."' />";
$plugin[2] = " <img src='$baseUrl/images/famfam/plugin_delete.png' alt='".$LANG['plugin_unregister']."' />";
$plugin[3] = " <img src='$baseUrl/images/famfam/plugin_add.png' alt='".$LANG['plugin_register']."' />";
$light[0] = " <img src='$baseUrl/images/famfam/lightbulb_off.png' alt='".$LANG['disabled']."' />";
$light[1] = " <img src='$baseUrl/images/famfam/lightbulb.png' alt='".$LANG['enabled']."' />";
$light[2] = " <img src='$baseUrl/images/common/lightswitch16x16.png' alt='".$LANG['toggle_status']."' />";
