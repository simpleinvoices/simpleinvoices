...
{* if  name was inserted *} 
	{if $smarty.post.id !=null} 
		...
		<img src="{$include_dir}sys/images/common/important.png" />
...
<table align="center">
	<tr>
		<td class="details_screen">{$LANG.description} 
			...
			<img src="{$include_dir}sys/images/common/required-small.png" /></a>
		</td>
	...
	<tr>
		<td class="details_screen">{$customFieldLabel.product_cf1} 
			...
			<img src="{$include_dir}sys/images/common/help-small.png" /></a>
		</td>
		<td>
