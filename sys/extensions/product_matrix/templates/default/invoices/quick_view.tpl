...
<!-- #PDF end -->
	...
	<tr>
		...
		<td class="account" nowrap>{$invoice_age} <a href='index.php?module=documentation&amp;view=view&amp;page=help_age' rel='gb_page_center[450, 450]'><img src="{$baseUrl}sys/images/common/help-small.png" alt="" /></a></td>
		<td></td>
