...
<table align="center">
	<tr>
		<td class="details_screen">{$LANG.product_description} <a href="index.php?module=documentation&amp;view=view&amp;page=help_required_field" rel="gb_page_center[350, 150]"><img src="../sys/images/common/required-small.png" alt="" /></a></td>
	...
	<tr>
		<td class="details_screen">{$customFieldLabel.product_cf1} <a href="index.php?module=documentation&amp;view=view&amp;page=help_custom_fields" rel="gb_page_center[450, 450]"><img src="../sys/images/common/help-small.png" alt="" /></a></td>
		<td><input type="text" name="custom_field1" value="{$smarty.post.custom_field1}" size="50" /></td>
	</tr>
	<tr>
		<td class="details_screen">{$customFieldLabel.product_cf2} <a href="index.php?module=documentation&amp;view=view&amp;page=help_custom_fields" rel="gb_page_center[450, 450]"><img src="../sys/images/common/help-small.png" alt="" /></a></td>
		<td><input type="text" name="custom_field2" value="{$smarty.post.custom_field2}" size="50" /></td>
	</tr>
	<tr>
		<td class="details_screen">{$customFieldLabel.product_cf3} <a href="index.php?module=documentation&amp;view=view&amp;page=help_custom_fields" rel="gb_page_center[450, 450]"><img src="../sys/images/common/help-small.png" alt="" /></a></td>
		<td><input type="text" name="custom_field3" value="{$smarty.post.custom_field3}" size="50" /></td>
	</tr>
	<tr>
		<td class="details_screen">{$customFieldLabel.product_cf4} <a href="index.php?module=documentation&amp;view=view&amp;page=help_custom_fields" rel="gb_page_center[450, 450]"><img src="../sys/images/common/help-small.png" alt="" /></a></td>
