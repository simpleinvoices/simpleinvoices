...
*}
	...
	<tr class='details_screen'>
		...
		<td colspan="5" align="right" class='details_screen align_right'>
			<a href='#' class="show-summary" onclick="$('.summary').show();$('.show-summary').hide();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_in.png" title="{$LANG.show_details}" alt="" /></a>
			<a href='#' class="summary" onclick="$('.summary').hide();$('.show-summary').show();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_out.png" title="{$LANG.hide_details}" alt="" /></a>
		</td>
	</tr>
	...
	<tr class='details_screen'>
		...
		<td colspan="2" class='details_screen align_right'>
			<a href='#' class="show-biller" onclick="$('.biller').show();$('.show-biller').hide();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_in.png" title="{$LANG.show_details}" alt="" /></a>
			<a href='#' class="biller" onclick="$('.biller').hide();$('.show-biller').show();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_out.png" title="{$LANG.hide_details}" alt="" /></a></td>
	</tr>
	...
	*}
	...
	<tr class='details_screen'>
		...
		<td colspan="2" class='details_screen align_right'>
			<a href='#' class="show-customer" {literal} onclick="$('.customer').show(); $('.show-customer').hide(); {/literal}"><img src="{$baseUrl}sys/images/common/magnifier_zoom_in.png" title="{$LANG.show_details}" alt=""/></a>
			<a href='#' class="customer" {literal} onclick="$('.customer').hide(); $('.show-customer').show(); {/literal}"><img src="{$baseUrl}sys/images/common/magnifier_zoom_out.png" title="{$LANG.hide_details}" alt="" /></a>
		</td>
	</tr>	
	...
	<tr class='details_screen customer'>
		...
		<a href="?module=invoices&view=usedefault&action=update_template&id={$invoice.id}&customer_id={$customer.id}"><img src="{$baseUrl}sys/images/flexigrid/load.png" title='{$LANG.invoice} {$invoice.id} {$LANG.as_template} {$LANG.for} {$customer.name}' alt="" /></a>
		</td>
...
{if $invoice.type_id == 2 || $invoice.type_id == 3  || $invoice.type_id == 4}
	...
	{if $invoice.type_id == 2 }
            ...
            <tr>
                    ...
                    <a href='#' class="show-itemised" onclick="$('.itemised').show();$('.show-itemised').hide();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_in.png" title="{$LANG.show_details}"/></a>
                    <a href='#' class="itemised" onclick="$('.itemised').hide();$('.show-itemised').show();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_out.png" title="{$LANG.hide_details}"/></a>
                    </td>
            </tr>
			<tr>
    ...
    {if $invoice.type_id == 3 }
			...
			<tr>
					<td colspan="6" class="details_screen align_right">
					<a href='#' class="show-consulting" onclick="$('.consulting').show();$('.show-consulting').hide();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_in.png" title="{$LANG.show_details}"/></a>
					<a href='#' class="consulting" onclick="$('.consulting').hide();$('.show-consulting').show();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_out.png" title="{$LANG.hide_details}"/></a>
					</td>
        	</tr>
			<tr>
               	 	<td><b>{$LANG.quantity_short}</b></td>
		...
		<tr class="details_screen">
			<td colspan="5"><b>{$LANG.notes}:</b></td>
				{if ($invoice.note|count_characters:true > 25)}
					<td class="details_screen align_right">
						<a href='#' class="show-notes" onclick="$('.notes').show();$('.show-notes').hide();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_in.png" title="{$LANG.show_details}" /></a>
						<a href='#' class="notes" onclick="$('.notes').hide();$('.show-notes').show();"><img src="{$baseUrl}sys/images/common/magnifier_zoom_out.png" title="{$LANG.hide_details}" /></a>
					</td>
				{/if}						
		</tr>
