...
*    Raffael Luthiger [r.luthiger@gmail.com]
*
* Last edited:
* 	 2011-08-05
*
...
/*// 1 means that the variable has been translated and
  // zero means it hasnt been translated - this is used by a script to calculate how much of each file has been done
...
$LANG['add_biller'] = "Rechnungssteller anlegen";//1
...
$LANG['add_item'] = "Artikel hinzufügen";//1
$LANG['add_new_biller'] = "Neuen Rechnungssteller hinzufügen";//1
...
$LANG['biller'] = "Rechnungssteller";//1
$LANG['biller_details'] = "Rechnungsstellerdetails";//1
$LANG['biller_edit'] = "Rechnungssteller bearbeiten";//1
$LANG['biller_id'] = "Rechnungssteller Nummer";//1
$LANG['biller_name'] = "Rechnungsstellername";//1
$LANG['biller_sales'] = "Rechnungssteller";//1
$LANG['biller_sales_by_customer_totals'] = "Rechnungssteller nach Kunden - Total"; //1
$LANG['biller_sales_total'] = "Rechnungssteller - Total";//1
$LANG['biller_to_add'] = "Rechnungssteller hinzufügen";//1
$LANG['billers'] = "Rechnungssteller";//1
...
$LANG['credit_card_number'] = "Kreditkarten Nummer";//1
$LANG['credit_card_number_encrypted'] = "Die Kreditkarten-Nummer wurde verschlüsselt und wird in Simple Invoices nicht angezeigt";//1
...
$LANG['customer_short'] = "Knd";//1
$LANG['customers'] = "Kunden";//1
$LANG['dashboard'] = "Übersichtstafel";//1
...
$LANG['debtors_by_aging_periods'] = "Schuldner nach Fälligkeitsdauer";//1
$LANG['debtors_by_amount_owed'] = "Schuldner nach geschuldetem Betrag";//1
$LANG['default_biller'] = "Standard Rechnungssteller";//1
...
$LANG['denied_page'] = "Sie haben keine Erlaubniss diese Seite zu sehen";//1
...
$LANG['email'] = "E-Mail";//1
$LANG['email_bcc'] = "E-Mail BCC (Blindkopie)";//1
$LANG['email_from'] = "E-Mail von";//1
$LANG['email_to'] = "E-Mail an";//1
...
$LANG['export_xls'] = "Exportieren als XLS";//1
...
$LANG['fax'] = "Fax";//1
$LANG['financial_status'] = "Finanzlage";//1
$LANG['format_tooltip'] = "Format";//1
$LANG['for'] = "für";//1
$LANG['from'] = "Von";//1
$LANG['fwrite_error'] = "Haben Sie fwrite Meldungen bekommen?";//1
...
$LANG['insert_biller'] = "Rechnungssteller anlegen";//1
...
$LANG['invoice_preference_to_add'] = "Rechnungseinstellung hinzufügen";//1
$LANG['invoice_preferences'] = "Rechnungseinstellungen";//1
$LANG['invoice_start'] = "Rechnung Start";//1
...
$LANG['manage_billers'] = "Rechnungssteller verwalten";//1
...
$LANG['none'] = "keine";//1
$LANG['note'] = "Notiz";//1
$LANG['notes'] = "Notizen";//1
$LANG['notes_opt'] = "Notizen (optional)";//1
...
$LANG['payments_filtered_customer'] = "Zahlung nach Kunde gefiltert";//0
...
$LANG['prepare_simple_invoices'] = "Simple Invoices gebrauchsfähig machen";//1
$LANG['Price'] = "Preis";//1
...
$LANG['products_sold_customer_total'] = "Produktverkäufe je Kunden - Total";//1
$LANG['products_sold_total'] = "Produktverkäufe - Total";//1
...
$LANG['Required_Field'] = "Erforderliches Feld";//1
$LANG['role'] = "Rolle";//1
$LANG['sales'] = "Verkäufe";//1
$LANG['sales_by_customers'] = "Verkäufe nach Kunden summiert";//1
$LANG['sales_report'] = "Verkaufsreport";//1
$LANG['sanity_check'] = "Konsistenzprüfung der Rechnungen";//1
$LANG['save'] = "Speichern";//1
$LANG['save_biller'] = "Rechnungssteller speichern";//1
$LANG['save_biller_failure'] = "Ein Fehler ist aufgetreten, bitte Rechnungssteller erneut versuchen zu sichern<br />";//1
$LANG['save_biller_success'] = "Rechnungssteller gesichert, <br />zurück zur vorherigen Seite";//1
...
$LANG['save_custom_field_success'] = "Freitext wurde gespeichert, <br />zurück zur vorherigen Seite";//1
...
$LANG['save_defaults_success'] = "System Einstellungen wurden erfolgreich gespeichert,<br />zurück zur vorherigen Seite";//1
...
$LANG['save_invoice_items_success'] = "Vorgang für Rechnung gespeichert<br /> zurück zur vorherigen Seite";//1
...
$LANG['save_payment_invoice_success'] = "Vorgang für Rechnung gespeichert, <br />zurück zur vorherigen Seite";//1
$LANG['save_payment_success'] = "Zahlungsvorgang gespeichert,<br />zurück zur vorherigen Seite";//1
...
$LANG['save_preference_success'] = "Rechnungseinstellungen gespeichert,<br />zurück zur vorherigen Seite";//1
...
$LANG['save_user_failure'] = "Etwas ist fehlgeschlagen, bitte versuchen Sie den Benutzer nochmals zu speichern<br />";//0
$LANG['save_user_success'] = "Benutzer erfolgreich gespeichert, <br /> Sie werden auf die Benutzerliste umgeleitet";//0
...
$LANG['stats_biller'] ="Top Rechnungssteller - nach Rechnungssumme";//1
...
$LANG['sum'] = "Betrag";//1
$LANG['summary'] = "Übersicht";//1
$LANG['summary_of_accounts'] = "Übersicht der Konten";//1
$LANG['system_defaults'] = "System-Voreinstellungen";//1
$LANG['system_preferences'] = "System Präferenzen";//1
$LANG['tax'] = "Steuer";//1
...
$LANG['total_paid'] = "Bezahlt gesammt";//1
