...
$LANG['auth_disabled'] = " Authentication disabled!";//1
$LANG['back'] = "Back";//1
...
$LANG['badd_UIDPWD'] = "Bad userid and/or password";//1
...
$LANG['default_rows_per_page'] = "Number of Items Per Page";//1
...
$LANG['distribute'] = "Distribute overpayments?";//1
$LANG['dont_forget_to'] = "Don't forget to";//1
$LANG['download'] = "Download"; //1
$LANG['draft'] = "Draft";//1
$LANG['due'] = "Due";//1
$LANG['edit'] = "Edit";//1
...
$LANG['help_default_rows_per_page_text'] = "This is the number of items listed on each resource listing page (Invoices, Estimates, People, etc.)";//1
...
$LANG['help_distribute_overpayment'] = "Payments that are larger than the total amount owing can be automatically spread over other outsdanding invoices the customer may have. The payment notes will hold a record of how the distribution was calculated.";//1
$LANG['help_distribute_overpayment_title'] = "Distributing overpayments";//1
...
$LANG['help_product_detail'] = "The product details field will auto-populate the invoice line items details when this product is selected from the drop down"; //1
...
$LANG['invoices_due']="Due invoices";//1
$LANG['invoices_paid']="Paid invoices";//1
$LANG['item'] = "Item";//1
...
$LANG['payment_larger'] = "was part of a larger payment of";//1
$LANG['payment_of'] = "This payment of";//1
$LANG['payment_split_over'] = "which has been automatically split over the following invoices:";//1
...
$LANG['payments_filtered_invoice'] = "Process Payment for this Invoice";//
...
$LANG['Required_UIDPWD'] = "Both username and password are required";//1
$LANG['role'] = "Role";//1
...
$LANG['save_payment_failure_distribute'] = "was not saved! Please try saving the <b>remaining</b> payment again.";//1
...
$LANG['version_installed'] = "The version id of your installed version is"; 
$LANG['version_latest'] = "Available version";
$LANG['version_notreq'] = ", but there's an optional update available";
$LANG['version_outofdate'] = "Your version is out of date, upgrade is advised.";
$LANG['version_ok'] = "Your version is up to date";
$LANG['version_current'] = "Your installed version of Simple Invoices is";
$LANG['version_server'] = "The available version in the download area is";
$LANG['version_server_installed'] = "The version id of the available version in the download area is";
$LANG['version_notes'] = "Release notes:";
$LANG['view'] = "View";//1
