...
$LANG['help_distribute_overpayment'] = "Payments that are larger than the total amount owing on the invoice can be automatically spread over other outsdanding invoices the customer may have. If you choose this option every payment will note how the distribution was calculated.";//1
