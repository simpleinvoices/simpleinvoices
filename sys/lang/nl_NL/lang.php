...
$LANG['email_biller_after_cron'] = "Email bedrijf na elke herhalingsfactuur";//1
$LANG['email_customer'] = "Email klant";//1
$LANG['email_customer_after_cron'] = "Email klant na elke herhalingsfactuur";//1
$LANG['email_from'] = "Van";//1
$LANG['email_to'] = "Naar";//1
$LANG['email_quick'] = "E-mail";//1
$LANG['enabled'] = "Ingeschakeld";//1
$LANG['end_date'] = "Eind datum (YYYY-MM-DD)"; //1
$LANG['estimate'] = "Schatting"; // 1
...
$LANG['invoice_settings'] = "Factuur instellingen"; //1
...
$LANG['number_of_taxes_per_line_item'] = "Aantal belasting toepassingen per itemregel ";//0
...
$LANG['real'] = "Werkelijk";//
$LANG['receipt'] = "Ontvangstbewijs"; //1
$LANG['recur_each'] = "Herhaal iedere";//1
...
$LANG['show_only_unpaid_invoices'] = "Toon alleen nog niet voldane facturen";//1
$LANG['simple_invoices'] = "Simple Invoices";//1
$LANG['simple_invoices_powered_by'] = "Powered by Simple Invoices";//1
$LANG['start_date'] = "Begindatum (YYYY-MM-DD)";
$LANG['start_working'] = "Begin met actie..";//1
$LANG['state'] = "Provincie";//1
$LANG['statement'] = "Verklaring";//1
$LANG['statement_for_the_period'] = "Verklaring over de periode";//1
$LANG['statement_of_invoices'] = "Verklaring over Facturen";//1
$LANG['statement_summary'] = "Verklaringssamenvatting";//1
$LANG['statements'] = "Verklaringen";//1
...
$LANG['system_settings'] = "Systeem instellingen"; //1
$LANG['tax'] = "BTW";//1
...
$LANG['thank_you'] = "Bedankt voor het gebruiken van Simple Invoices!";//1
...
$LANG['version_ok'] = "Uw versie is up to date";
