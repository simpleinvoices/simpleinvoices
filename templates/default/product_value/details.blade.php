...
<div class="card">
	...
	<div class="card-footer">
		<div class="d-flex">
			...
			<a href="./index.php?module=product_value&amp;view=details&amp;id={{ $product_value['id'] ?? '' }}&amp;action=edit" class="btn btn-primary ms-auto"><i class="ti ti-edit me-1"></i>{{ $LANG['edit'] ?? 'Edit' }}</a>
		</div>
	</div>
</div>
