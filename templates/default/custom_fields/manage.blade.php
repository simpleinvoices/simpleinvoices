...
@else
	...
	<div class="mt-3">
		<a class="cluetip btn btn-outline-secondary" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_what_are_custom_fields" title="{{ $LANG['what_are_custom_fields'] ?? '' }}"><i class="ti ti-help me-1"></i>{{ $LANG['what_are_custom_fields'] ?? '' }}</a>
		<a class="cluetip btn btn-outline-secondary ms-1" href="#" rel="index.php?module=documentation&amp;view=view&amp;page=help_manage_custom_fields" title="{{ $LANG['whats_this_page_about'] ?? '' }}"><i class="ti ti-help me-1"></i>{{ $LANG['whats_this_page_about'] ?? '' }}</a>
	</div>
@endif
</div>
