...
Ext.onReady(function(){
	...
	function renderActions(value, p, record){
		...
		'<!--4 XLS --><a title="'+ export_xls_tooltip +'" class="index_table" href="index.php?module=invoices&amp;view=templates/template&amp;invoice={1}&amp;action=view&amp;location=print&amp;export={{ urlencode($spreadsheet) }}"><img src="images/common/page_white_excel.png" height="16" border="0" padding="-4px" valign="bottom" alt="" /><!-- $spreadsheet --></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
		...
		'<!--5 DOC --><a title="'+ export_word_tooltip +'" class="index_table" href="index.php?module=invoices&amp;view=templates/template&amp;invoice={1}&amp;action=view&amp;location=print&amp;export={{ urlencode($word_processor) }}"><img src="images/common/page_white_word.png" height="16" border="0" padding="-4px" valign="bottom" alt="" /><!-- $word_processor --></a>',
		value,
		record.id,
		record.data.type_id,
		record.data.forumid);
