<form name="frmpost" action="index.php?module=payments&amp;view=save" method="post"
...
<div class="si_form">
  <table>  
    ...
    <tr>
        ...
        <td>
          <input type="text" class="date-picker" name="ac_date" id="date1"
                 value="{$today|htmlsafe}" />
        </td>
    </tr>  
    {/if}
    <tr>
