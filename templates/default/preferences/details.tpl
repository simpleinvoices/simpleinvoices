...
<b>Preferences</b>
	<hr></hr>
        ...
        <table align=center>
                ...
                <tr>
                        <td class='details_screen'>Description <a href="docs.php?t=help&p=inv_pref_description" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td><td><input type=text name='pref_description' value="{$preference.pref_description|regex_replace:"/[\r\t\\\]/":""}" size=50></td>
                </tr>
                <tr>
                ...
                <tr>
                        <td class='details_screen'>Invoice heading <a href="docs.php?t=help&p=inv_pref_invoice_heading" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a><td><input type=text name='pref_inv_heading' value="{$preference.pref_inv_heading|regex_replace:"/[\r\t\\\]/":""}" size=50></td>
                </tr>
                <tr>
                        <td class='details_screen'>Invoice wording <a href="docs.php?t=help&p=inv_pref_invoice_wording" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td><td><input type=text name='pref_inv_wording' value="{$preference.pref_inv_wording|regex_replace:"/[\r\t\\\]/":""}" size=50></td>
                </tr>
                <tr>
                        <td class='details_screen'>Invoice detail heading <a href="docs.php?t=help&p=inv_pref_invoice_detail_heading" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td><td><input type=text name='pref_inv_detail_heading' value="{$preference.pref_inv_detail_heading|regex_replace:"/[\r\t\\\]/":""}" size=50></td>
                </tr>
                <tr>
                        <td class='details_screen'>Invoice detail line <a href="docs.php?t=help&p=inv_pref_invoice_detail_line" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td><td><input type=text name='pref_inv_detail_line' value="{$preference.pref_inv_detail_line|regex_replace:"/[\r\t\\\]/":""}" size=75></td>
                </tr>
                <tr>
                        <td class='details_screen'>Invoice payment method <a href="docs.php?t=help&p=inv_pref_invoice_payment_method" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td><td><input type=text name='pref_inv_payment_method' value="{$preference.pref_inv_payment_method|regex_replace:"/[\r\t\\\]/":""}" size=50></td>
                </tr>
                <tr>
                        <td class='details_screen'>Invoice payment line1 name <a href="docs.php?t=help&p=inv_pref_payment_line1_name" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td><td><input type=text name='pref_inv_payment_line1_name' value="{$preference.pref_inv_payment_line1_name|regex_replace:"/[\r\t\\\]/":""}" size=50></td>
                </tr>
                <tr>
                ...
                <tr>
                        <td class='details_screen'>Invoice payment line2 name <a href="docs.php?t=help&p=inv_pref_payment_line2_name" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td><td><input type=text name='pref_inv_payment_line2_name' value="{$preference.pref_inv_payment_line2_name|regex_replace:"/[\r\t\\\]/":""}" size=50></td>
                </tr>
                <tr>
