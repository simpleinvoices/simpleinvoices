    ...
    <table class="center">
      ...
      <tr>
        ...
        <td><input type="text" class="edit" name="reorder_level"
                   value="{$product.reorder_level|htmlsafe}" size="25" /></td>
      </tr>
      {/if}
      <tr>
        <th>{$LANG.default_tax}</th>
      ...
      <tr>
        ...
        <td><input type="text" name="custom_field1" size="50"
                   value="{$product.custom_field1|htmlsafe}" /></td>
      </tr>
      {/if}
      {if !empty($customFieldLabel.product_cf2)}
      <tr>
        ...
        <td><input type="text" name="custom_field2" size="50"
                   value="{$product.custom_field2|htmlsafe}" /></td>
      </tr>
      {/if}
      {if !empty($customFieldLabel.product_cf3)}
      <tr>
        ...
        <td><input type="text" name="custom_field3" size="50"
                   value="{$product.custom_field3|htmlsafe}" /></td>
      </tr>
      {/if}
      {if !empty($customFieldLabel.product_cf4)}
      <tr>
        ...
        <td><input type="text" name="custom_field4" size="50"
                   value="{$product.custom_field4|htmlsafe}" /></td>
      </tr>
      {/if}
      {if $defaults.product_attributes}
      <tr>
