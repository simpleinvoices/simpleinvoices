...
<b>System defaults</b>
	...
	<tr>
		<td class='details_screen'><a href='index.php?module=system_defaults&view=edit&submit=inv_preference'>Edit</a></td><td class='details_screen'>Invoice preference</td><td>{$defaultInvoice.pref_description}</td>
	</tr>
	<tr>
	...
	<tr>
		<td class='details_screen'><a href='index.php?module=system_defaults&view=edit&submit=def_payment_type'>Edit</a></td><td class='details_screen'>Default payment type</td><td>{$defaultPaymentType.pt_description}</td>
	</tr>
        </table>
