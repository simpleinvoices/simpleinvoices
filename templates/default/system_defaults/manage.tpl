...
<b>{$LANG.system_defaults}</b>
	...
	<tr>
		<td class='details_screen'><a href='index.php?module=system_defaults&view=edit&submit=preference_id'>{$LANG.edit}</a></td><td class='details_screen'>{$LANG.inv_pref}</td><td>{$defaultInvoice.pref_description}</td>
	</tr>
	<tr>
		<td class='details_screen'><a href='index.php?module=system_defaults&view=edit&submit=line_items'>{$LANG.edit}</a></td><td class='details_screen'>{$LANG.default_number_items}</td><td>{$defaults.items}</td>
	</tr>
	<tr>
