<script type="text/javascript">
		...
		siTablerGrid('#manageGrid', {
			...
			colModel : [
				...
				{display: @json($LANG['status'] ?? ''), name : 'enabled', width : 20 * percentage_width, sortable : true, align: 'center'},
				{display: @json($LANG['visible'] ?? ''), name : 'visible', width : 20 * percentage_width, sortable : true, align: 'center'}
			],
