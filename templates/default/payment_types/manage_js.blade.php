<script type="text/javascript">
		...
		siTablerGrid('#manageGrid', {
			...
			colModel : [
				...
				{display: @json($LANG['description'] ?? ''), name : 'pt_description', width : 70 * percentage_width, sortable : true, align: 'left'},
			...
			searchitems : [
				{display: @json($LANG['description'] ?? ''), name : 'pt_description', isdefault: true}
			],
