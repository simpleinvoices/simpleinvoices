	...
	<div class="card-header">
		<ul class="nav nav-tabs card-header-tabs" role="tablist">
			<li class="nav-item" role="presentation">
				<a class="nav-link active" href="#bill-add-details" data-bs-toggle="tab" role="tab">{{ $LANG['details'] ?? '' }}</a>
			</li>
			<li class="nav-item" role="presentation">
				<a class="nav-link" href="#bill-add-address" data-bs-toggle="tab" role="tab">{{ $LANG['address'] ?? 'Address' }}</a>
			</li>
			<li class="nav-item" role="presentation">
				<a class="nav-link" href="#bill-add-contact" data-bs-toggle="tab" role="tab">{{ $LANG['contacts'] ?? 'Contacts' }}</a>
			</li>
			<li class="nav-item" role="presentation">
				<a class="nav-link" href="#bill-add-payment" data-bs-toggle="tab" role="tab">{{ $LANG['payment'] ?? 'Payment' }}</a>
			</li>
			<li class="nav-item" role="presentation">
				<a class="nav-link" href="#bill-add-custom" data-bs-toggle="tab" role="tab">{{ $LANG['custom_fields'] ?? '' }}</a>
			</li>
			<li class="nav-item" role="presentation">
				<a class="nav-link" href="#bill-add-invoice" data-bs-toggle="tab" role="tab">{{ $LANG['invoice'] ?? 'Invoice' }}</a>
			</li>
		</ul>
	</div>
	<div class="card-body">
