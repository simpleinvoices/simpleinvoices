...
<div id="container">
	...
	<table class="right invoice-summary-table">
		...
		<tr>
				...
				<td class="" align="right" colspan="3">{{ $invoice['denorm_index_id'] ?? '' }}</td>
		</tr>
		<tr>
	...
	<!-- Show the Invoice Custom Fields if valid -->
		...
		<tr>
				...
				<td class="" align="right" colspan="3">{!! CurrencySignHelper::formatInvoice($invoice['total'] ?? 0, $invoice, $preference) !!}</td>
		</tr>
		<tr>
				<td class="">{{ $LANG['paid'] ?? '' }}:</td>
				<td class="" align="right" colspan="3" >{!! CurrencySignHelper::formatInvoice($invoice['paid'] ?? 0, $invoice, $preference) !!}</td>
		</tr>
		<tr>
				<td nowrap class="">{{ $LANG['owing'] ?? '' }}:</td>
				<td class="" align="right" colspan="3" >{!! CurrencySignHelper::formatInvoice($invoice['owing'] ?? 0, $invoice, $preference) !!}</td>
		</tr>
	...
	@if(($invoice['type_id'] ?? null) == 2 )
			...
			<tr class="" >
				...
				<td class="" align="right">{!! CurrencySignHelper::formatInvoice($invoiceItem['unit_price'] ?? 0, $invoice, $preference) !!}</td>
				<td class="" align="right">{!! CurrencySignHelper::formatInvoice($invoiceItem['gross_total'] ?? 0, $invoice, $preference) !!}</td>
			</tr>
	...
	@if(($invoice['type_id'] ?? null) == 3 )
			...
			<tr class="">
				...
				<td class=""></td>
				<td class=""></td>
				<td align="right" class="">{!! CurrencySignHelper::formatInvoice($invoiceItem['unit_price'] ?? 0, $invoice, $preference) !!}</td>
				<td align="right" class="">{!! CurrencySignHelper::formatInvoice($invoiceItem['total'] ?? 0, $invoice, $preference) !!}</td>
			</tr>
			@endforeach
	@endif
...
@endif
    ...
    <tr>
		...
		<td colspan="1" align="right"><span class="double_underline"><u>{!! CurrencySignHelper::formatInvoice($invoice['total'] ?? 0, $invoice, $preference) !!}</u></span></td>
    </tr>
    {{-- tax section - end --}}
{{-- <tr>
			<td class="" colspan="2"></td>
			<td align="right" colspan="3">{{ $LANG['sub_total'] ?? '' }}</td>
			<td align="right" class="">{!! CurrencySignHelper::formatInvoice($invoice['gross'] ?? 0, $invoice, $preference) !!}</td>
		</tr>
	...
	<tr class="">
		...
		<td  class="" align="right"><span class="double_underline" >{!! CurrencySignHelper::formatInvoice($invoice['total'] ?? 0, $invoice, $preference) !!}</span></td>
	</tr> --}}
	<tr>
	...
	<tr>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line0_name'] ?? '' }}</td>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line0_value'] ?? '' }}</td>
	</tr>
	@endif
	@if(!empty(($preference['pref_inv_payment_line1_value'] ?? '')))
	<tr>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line1_name'] ?? '' }}</td>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line1_value'] ?? '' }}</td>
	</tr>
	@endif
	@if(!empty(($preference['pref_inv_payment_line2_value'] ?? '')))
	<tr>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line2_name'] ?? '' }}</td>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line2_value'] ?? '' }}</td>
	</tr>
	@endif
	@if(!empty(($preference['pref_inv_payment_line3_value'] ?? '')))
	<tr>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line3_name'] ?? '' }}</td>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line3_value'] ?? '' }}</td>
	</tr>
	@endif
	@if(!empty(($preference['pref_inv_payment_line4_value'] ?? '')))
	<tr>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line4_name'] ?? '' }}</td>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line4_value'] ?? '' }}</td>
	</tr>
	@endif
	@if(!empty(($preference['pref_inv_payment_line5_value'] ?? '')))
	<tr>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line5_name'] ?? '' }}</td>
		<td class="" colspan="3">{{ $preference['pref_inv_payment_line5_value'] ?? '' }}</td>
	</tr>
	@endif
	<tr>
		<td><br /></td>
