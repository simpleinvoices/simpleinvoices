...
CREATE TABLE IF NOT EXISTS si_biller (
  ...
  paypal_test_mode             INTEGER NOT NULL DEFAULT 1,
  ...
  authorizenet_test_mode       INTEGER NOT NULL DEFAULT 1,
  eway_api_key                 TEXT DEFAULT NULL,
  eway_api_password            TEXT DEFAULT NULL,
  eway_test_mode               INTEGER NOT NULL DEFAULT 1,
  kofi_username                TEXT DEFAULT NULL,
