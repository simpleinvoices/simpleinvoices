...
function LayersMenuCommon()
{
	...
	$this->dirroot = '.menu/';
	$this->libjsdir = './menu/libjs/';
	$this->imgdir = './menu/menuimages/';
	$this->imgwww = 'menu/menuimages/';
	$this->icondir = './menu/menuicons/';
	$this->iconwww = 'menu/menuicons/';
	$this->tpldir = './menu/templates/';
	$this->menuStructure = '';
	$this->separator = '|';
