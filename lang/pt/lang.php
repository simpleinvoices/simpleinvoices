...
$LANG['aging'] = "Idade";//1
$LANG['amount'] = "Valor";//1
$LANG['attention_short'] = "Ac.";//1
$LANG['backup_database'] = "Cópia de segurança da base de dados";//1
...
$LANG['custom_field_db_field_name'] = "Nome do campo na base de dados";//1
...
$LANG['default_number_items'] = "Número de itens por omissão:";//1
...
$LANG['no_defaults'] = "Não existem valores por omissão";//1
...
$LANG['save_biller_failure'] = "Alguma coisa correu mal. Por favor, tente gravar novamente o facturador<br>";//1
...
$LANG['save_custom_field_failure'] = "Alguma coisa correu mal. Por favor, tente editar o campo personalizado novamente<br>";//1
$LANG['save_custom_field_success'] = "Campo personalizado gravado com sucesso,<br> Vai ser redireccionado para a página de gestão de campos personalizados";//1
...
$LANG['save_customer_success'] = "Cliente gravado com sucesso,<br> Vai ser redireccionado para a página de gestão de clientes";//1
$LANG['save_defaults'] = "Gravar valores por omissão";//1
$LANG['save_defaults_success'] = "Os valores por omissão do sistema foram actualizados com sucesso,<br> Vai ser redireccionado para a página de gestão dos parâmetros do sistema";//1
$LANG['save_defaults_failure'] = "Alguma coisa correu mal. Por favor, tente definir os valores por omissão novamente";//1
...
$LANG['save_invoice_items_success'] = "A processar item da factura,<br> Vai ser redireccionado para a página desta factura";//1
$LANG['save_invoice_success'] = "A processar factura,<br> Vai ser redireccionado para a página desta factura";//1
$LANG['save_payment_failure'] = "Alguma coisa correu mal. Por favor, tente gravar o pagamento novamente";//1
$LANG['save_payment_invoice_success'] = "Pagamento processado com sucesso,<br> Vai ser redireccionado para a página de gestão de facturas";//1
$LANG['save_payment_success'] = "Pagamento processado com sucesso,<br> Vai ser redireccionado para a página de gestão de pagamentos";//1
$LANG['save_payment_type'] = "Guardar Tipo de Pagamento";//1
$LANG['save_payment_type_failure'] = "Alguma coisa correu mal. Por favor, tente gravar o pagamento novamente";//1
$LANG['save_payment_type_success'] = "Tipo de pagamento gravado com sucesso,<br> Vai ser redireccionado para a página de gestão de tipos de pagamento";//1
$LANG['save_preference_failure'] = "Alguma coisa correu mal. Por favor, tente gravar novamente as preferências da factura";//1
$LANG['save_preference_success'] = "Preferências da factura gravadas com sucesso,<br> Vai ser redireccionado para a página de gestão de preferências";//1
$LANG['save_product'] = "Guardar Produto";//1
$LANG['save_product_failure'] = "Alguma coisa correu mal. Por favor, tente gravar o produto novamente";//1
$LANG['save_product_success'] = "Produto gravado com sucesso,<br> Vai ser redireccionado para a página de gestão de produtos";//1
$LANG['save_tax_rate'] = "Guardar Taxas de Impostos";//1
$LANG['save_tax_rate_failure'] = "Alguma coisa correu mal. Por favor, tente adicionar novamente o valor do imposto";//1
$LANG['save_tax_rate_success'] = "Valor do imposto gravado com sucesso,<br> Vai ser redireccionado para a página de gestão dos valores dos impostos";//1
