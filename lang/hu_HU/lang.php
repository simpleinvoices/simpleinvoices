...
$LANG['add_new_invoice'] = "Számla Hozzáadása";//1
$LANG['add_new_payment'] = "Fizetés Hozzáadása";//1
$LANG['add_new_payment_type'] = "Fizetési Mód Hozzáadása";//1
$LANG['add_new_preference'] = "Add Preference";//1
$LANG['add_new_product'] = "Termék Hozzáadása";//1
$LANG['add_new_row'] = "Új Sor Hozzáadása";//1
$LANG['add_new_tax_rate'] = "Adókulcs Hozzáadása";//1
...
$LANG['back'] = "Vissza";//1
$LANG['backed_up_successfully'] = "Sikeresen mentve";//1
$LANG['backup_database'] = "Adatbázis Mentés";//1
$LANG['backup_database_now'] = "ADATBÁZIS MENTÉSE MOST";//1
$LANG['backup_done'] = "Az adatbázis elmentésre került a %s fájlba, most már folytathatja a Simple Invoices Használatát";//1
...
$LANG['city'] = "Város";//1
$LANG['close'] = "Bezárás";//1
$LANG['configured'] = "Configured";//0
$LANG['confirm_delete'] = "Are you sure you want to delete";//1
$LANG['contact_person'] = "Kapcsolattartó";//1
$LANG['contacts'] = "Kapcsolatok";//1
$LANG['copied'] = "Másolva!";//1
$LANG['copy_sql'] = "SQL Másolása";//1
$LANG['cost'] = "Költség";//1
$LANG['cost_price'] = "Beszerzési ár";//1
...
$LANG['download_backup'] = "Biztonsági Mentés Letöltése";//1
$LANG['download_sql_backup'] = "SQL biztonsági mentés letöltése";//1
$LANG['draft'] = "Draft";//1
$LANG['due'] = "Due";//1
$LANG['edit'] = "Edit";//1
$LANG['edit_profile'] = "Profil Szerkesztése";//1
...
$LANG['email_invoice_as_pdf'] = "%s elküldése az Ügyfélnek PDF-ként";//1
...
$LANG['extensions_removed'] = "A bővítmények eltávolításra kerültek ebből a telepítésből. Csak az alapalkalmazás támogatott.";//1
...
$LANG['first_run_intro'] = "Üdvözöljük! A számlázás megkezdéséhez végezze el ezeket a lépéseket:";//1
...
$LANG['grid_connection_error'] = "Kapcsolati hiba";//1
$LANG['grid_invalid_xml'] = "Érvénytelen XML-válasz";//1
$LANG['grid_records'] = "rekordok";//1
$LANG['grid_reload'] = "Újratöltés";//1
$LANG['grid_search'] = "Keresés";//1
$LANG['grid_search_placeholder'] = "Keresés";//1
$LANG['grid_sort_by'] = "Rendezés {column} szerint";//1
...
$LANG['help_options_menu'] = "A %s beállításával, telepítésével és használatával kapcsolatos információkért tekintse meg a Beállítások menü Utasítások almenüjét.";//1
$LANG['help_other_queries'] = "Egyéb kérdések esetén keresse fel a(z) %s weboldalt %s és a(z) %s fórumot itt: %s";//1
...
$LANG['install_database_and_essential'] = "Adatbázis és alapadatok telepítése";//1
$LANG['install_documentation'] = "telepítési dokumentációt";//1
$LANG['install_essential_done'] = "A Simple Invoices alapadatai importálva lettek. Most már elkezdheti használni a Simple Invoices-t.";//1
$LANG['install_help'] = "Ha bármilyen problémája vagy kérdése van a telepítéssel kapcsolatban, kérjük, olvassa el a";//1
$LANG['install_intro'] = "A Simple Invoices telepítéséhez:";//1
$LANG['install_sample_data'] = "Mintaadatok telepítése";//1
$LANG['install_sample_optional'] = "Opcionálisan telepíthet mintaadatokat (demó számlák, ügyfelek, termékek), hogy felfedezze az alkalmazást.";//1
$LANG['install_setup_done'] = "Az adatbázis és az alapadatok telepítve lettek. Most már elkezdheti használni a Simple Invoices-t.";//1
$LANG['install_step_config'] = "Adja meg a helyes adatbázis-kapcsolati adatokat a config/config.php fájlban";//1
$LANG['install_step_db'] = "Hozzon létre egy üres MySQL adatbázist, lehetőleg UTF-8 kódolással";//1
$LANG['install_step_review'] = "Ellenőrizze az alábbi kapcsolati adatokat, és ha helyesek, kattintson a gombra az adatbázis és az alapadatok telepítéséhez.";//1
...
$LANG['invoice_settings'] = "Számlabeállítások";//1
$LANG['invoice_start'] = "Invoice Start";//1
$LANG['invoice_status'] = "Számla állapota";//1
...
$LANG['manage_accounts'] = "Felhasználók kezelése";//1
...
$LANG['money'] = "Money";//1
$LANG['monthly_activity'] = "Havi tevékenység";//1
...
$LANG['patch_id'] = "Javítás azonosító";//1
...
$LANG['postcode'] = "Irányítószám";//1
$LANG['preference'] = "preference";//1
$LANG['preference_description_required'] = "Meg kell adnia a beállítás leírását";//1
...
$LANG['profit_per_invoice_summary'] = "Számlánkénti profit az átlagos termékköltség alapján, a(z) {start_date} és {end_date} közötti időszakra";//1
...
$LANG['rate'] = "Rate";//1
$LANG['real'] = "Real";//1
$LANG['receipt'] = "Nyugta";//1
$LANG['recent_invoices'] = "Legutóbbi Számlák";//1
$LANG['recent_payments'] = "Legutóbbi Fizetések";//1
$LANG['recur_each'] = "Recur each";//1
$LANG['recurrence'] = "Recurrence";//1
$LANG['recurrence_type'] = "Recurrence_type";//1
$LANG['register'] = "Register";//1
$LANG['release'] = "Kiadás";//1
...
$LANG['sample_data_done'] = "A mintaadatok importálva lettek a Simple Invoices rendszerbe. Néhány másodpercen belül átirányítjuk, vagy kattintson lent a folytatáshoz.";//1
$LANG['sample_data_error'] = "A mintaadatok importálása sikertelen";//1
$LANG['sample_data_error_msg'] = "Valami hiba történt. A mintaadatok NEM kerültek importálásra a Simple Invoices rendszerbe.";//1
$LANG['sample_data_installed'] = "Mintaadatok telepítve";//1
$LANG['sanity_check'] = "Sanity check of invoices";//1
$LANG['sanity_check_wip'] = "Ez a funkció még fejlesztés alatt áll; a frissítésekért keresse fel kezdőlapunkat: %s.";//1
$LANG['save'] = "Save";//1
...
$LANG['sent'] = "Elküldve";//1
$LANG['setting'] = "Beállítás";//1
...
$LANG['setup_complete'] = "Beállítás kész";//1
...
$LANG['setup_database'] = "Adatbázis beállítása";//1
$LANG['shortcut'] =" Shortcut menu";//1
$LANG['show_all'] = "Összes megjelenítése";//1
...
$LANG['start_using_simple_invoices'] = "Simple Invoices használatának megkezdése";//1
...
$LANG['support'] = "Támogatás";//1
$LANG['switch_to_dark_mode'] = "Váltás sötét módra";//1
$LANG['switch_to_light_mode'] = "Váltás világos módra";//1
$LANG['system_defaults'] = "System Defaults";//1
$LANG['system_preferences'] = "System Preferences";//1
$LANG['table'] = "Táblázat";//1
$LANG['tax'] = "Tax";//1
...
$LANG['user_menu'] = "Felhasználói menü";//1
$LANG['username'] = "Felhasználónév";//1
$LANG['users'] = "Users";//1
$LANG['using_simple_invoices'] = "Using Simple Invoices";//1
$LANG['value'] = "Value";//1
$LANG['view'] = "View";//1
$LANG['view_sql'] = "SQL megtekintése";//1
...
$LANG['wizard_add_a_customer'] = "Ügyfél Hozzáadása";//1
$LANG['wizard_add_a_product'] = "Termék vagy Szolgáltatás Hozzáadása";//1
$LANG['wizard_add_your_details'] = "Adatainak Hozzáadása";//1
$LANG['wizard_all_invoices'] = "Összes Számla";//1
$LANG['wizard_all_set'] = "Minden be van állítva és számlázhat!";//1
$LANG['wizard_all_set_tagline'] = "Menjen a számlalistára a számlái megtekintéséhez.";//1
...
$LANG['wizard_biller_ready'] = "A számlázási adatai be vannak állítva!";//1
$LANG['wizard_biller_ready_tagline'] = "Az adatait bármikor frissítheti.";//1
$LANG['wizard_business_name'] = "Vállalkozás / Az Ön Neve";//1
$LANG['wizard_create_first_invoice'] = "Első Számla Létrehozása";//1
$LANG['wizard_create_invoice'] = "Számla Létrehozása";//1
$LANG['wizard_customer_ready'] = "Legalább egy ügyfél be van állítva!";//1
$LANG['wizard_customer_ready_tagline'] = "Bármikor hozzáadhat több ügyfelet.";//1
$LANG['wizard_done_badge'] = "Kész";//1
$LANG['wizard_full_biller_form'] = "Teljes számlázó űrlap (több lehetőség)";//1
$LANG['wizard_full_customer_form'] = "Teljes ügyfél-űrlap (több lehetőség)";//1
$LANG['wizard_full_product_form'] = "Teljes termék-űrlap (több lehetőség)";//1
$LANG['wizard_prefills_form'] = "Előre kitölti az űrlapot - szerkessze mentés előtt.";//1
$LANG['wizard_prereqs_biller'] = "Adja hozzá a számlázási adatait (1. lépés)";//1
$LANG['wizard_prereqs_customer'] = "Adjon hozzá egy ügyfelet (2. lépés)";//1
$LANG['wizard_prereqs_intro'] = "Számla létrehozása előtt el kell végeznie a korábbi lépéseket:";//1
$LANG['wizard_prereqs_product'] = "Adjon hozzá egy terméket vagy szolgáltatást (3. lépés)";//1
$LANG['wizard_product_ready'] = "Legalább egy termék/szolgáltatás be van állítva!";//1
$LANG['wizard_product_ready_tagline'] = "Bármikor hozzáadhat több terméket vagy szolgáltatást.";//1
$LANG['wizard_ready_click_below'] = "Kattintson az alábbi gombra az új számla-űrlap megnyitásához.";//1
$LANG['wizard_ready_tagline'] = "A számlázó, az ügyfél és a termékek mind készen állnak.";//1
$LANG['wizard_ready_to_go'] = "Kész az indulásra!";//1
$LANG['wizard_sample_added'] = "Mintaadatok hozzáadva - következő lépésre irányítjuk…";//1
$LANG['wizard_sample_failed'] = "Nem sikerült hozzáadni a mintaadatokat. Kérjük, próbálja újra.";//1
$LANG['wizard_sample_replace_later'] = "A mintaadatokat később szerkesztheti vagy lecserélheti.";//1
$LANG['wizard_save_details'] = "Adatok Mentése";//1
$LANG['wizard_starting_number_hint'] = "The number from which new invoices in this group will start.";//0
$LANG['wizard_state_region'] = "Megye / Régió";//1
$LANG['wizard_try_sample'] = "Csak ki szeretné próbálni először?";//1
$LANG['wizard_use_sample_biller'] = "Minta számlázói adatok használata";//1
$LANG['wizard_use_sample_customer'] = "Minta ügyfél-adatok használata";//1
$LANG['wizard_use_sample_product'] = "Minta termék-adatok használata";//1
$LANG['wizard_your_details'] = "Az Ön Adatai";//1
$LANG['years'] = "years";//1
$LANG['yes'] = "Yes";//1
