...
/*
* Script: lang.php
* 	Galego-Português translation file
*
* Last edited:
*    2016-10-04
*
...
$LANG['add_new_biller'] = "Engadir emisor";//1
$LANG['add_new_invoice'] = "Engadir factura";//1
$LANG['add_new_payment'] = "Add Payment";//0
$LANG['add_new_payment_type'] = "Engadir tipo de pago";//1
$LANG['add_new_preference'] = "Engadir unha preferencia de facturación";//1
$LANG['add_new_product'] = "Engadir produto";//1
$LANG['add_new_row'] = "Engadir unha nova fila";//1
$LANG['add_new_tax_rate'] = "Engadir taxa de impostos";//1
...
$LANG['back'] = "Back";//1
$LANG['backed_up_successfully'] = "Copia de seguranza realizada correctamente";//1
...
$LANG['cost'] = "Custo";//1
$LANG['cost_price'] = "Prezo de custo";//1
$LANG['country'] = "País";//1
...
$LANG['credit_card_number_encrypted'] = "O número da tarxeta de crédito foi cifrado e non se amosará en Simple Invoices";//1
$LANG['credit_card_number_new'] = "Número novo da tarxeta de crédito";//1
$LANG['credits'] = "Credits";//1
$LANG['cron_id'] = "ID do cron";//1
$LANG['cron_log'] = "Rexistro do cron";//1
...
$LANG['customer_add'] = "Engadir cliente";//1
...
$LANG['database_tools'] = "Ferramentas da base de datos";//1
...
$LANG['essential_data_installed'] = "Datos esenciais instalados";//1
$LANG['eway'] = "Eway";//1
...
$LANG['extensions_removed'] = "As extensións foron retiradas desta instalación. Só se admite a aplicación principal.";//1
...
$LANG['faqs_what'] ="Que é Simple Invoices?";//1
$LANG['fax'] = "Fax";//1
...
$LANG['first_run_intro'] = "Benvido. Complete estes pasos para comezar a facturar:";//1
...
$LANG['grid_connection_error'] = "Erro de conexión";//1
$LANG['grid_invalid_xml'] = "Resposta XML non válida";//1
$LANG['grid_records'] = "rexistros";//1
...
$LANG['help_options_menu'] = "Para obter información sobre a configuración, a instalación e o uso de %s, consulte o submenú Instrucións do menú Opcións.";//1
$LANG['help_other_queries'] = "Para outras consultas, visite o sitio web de %s %s e o foro de %s en %s";//1
...
$LANG['help_si_help'] = "Axuda de Simple Invoices";//1
...
$LANG['install_database_and_essential'] = "Instalar a base de datos e os datos esenciais";//1
$LANG['install_documentation'] = "documentación de instalación";//1
$LANG['install_essential_done'] = "Os datos esenciais de Simple Invoices importáronse. Agora xa podes comezar a usar Simple Invoices.";//1
$LANG['install_help'] = "Se tes algún problema ou dúbida sobre a instalación, consulta a";//1
$LANG['install_intro'] = "Para instalar Simple Invoices, por favor:";//1
$LANG['install_sample_data'] = "Instalar datos de mostra";//1
$LANG['install_sample_optional'] = "Opcionalmente, podes instalar datos de mostra (facturas de demostración, clientes e produtos) para explorar a aplicación.";//1
$LANG['install_setup_done'] = "A base de datos e os datos esenciais foron instalados. Agora xa podes comezar a usar Simple Invoices.";//1
$LANG['install_step_config'] = "Introduce os datos correctos da conexión á base de datos no ficheiro config/config.php";//1
$LANG['install_step_db'] = "Crea unha base de datos MySQL baleira, preferiblemente con colación UTF-8";//1
$LANG['install_step_review'] = "Revisa os datos da conexión a continuación e, se son correctos, preme o botón para instalar a base de datos e os datos esenciais.";//1
...
$LANG['invoice_status'] = "Estado da factura";//1
...
$LANG['manage_accounts'] = "Xestionar usuarios";//1
...
$LANG['preference_description_required'] = "Debe introducir unha descrición para a preferencia";//1
...
$LANG['profit_per_invoice_summary'] = "Beneficio por factura baseado no custo medio dos produtos para o período {start_date} a {end_date}";//1
...
$LANG['sample_data_done'] = "Os datos de mostra importáronse en Simple Invoices. Serás redirixido nuns segundos ou preme abaixo para continuar.";//1
$LANG['sample_data_error'] = "A importación dos datos de mostra fallou";//1
$LANG['sample_data_error_msg'] = "Algo saíu mal. Os datos de mostra NON se importaron en Simple Invoices.";//1
$LANG['sample_data_installed'] = "Datos de mostra instalados";//1
$LANG['sanity_check'] = "Sanity check of invoices";//1
$LANG['sanity_check_wip'] = "Esta función aínda está en desenvolvemento; consultade a nosa páxina principal: %s para actualizacións.";//1
$LANG['save'] = "Save";//1
...
$LANG['setup_database'] = "Configurar a base de datos";//1
...
$LANG['start_using_simple_invoices'] = "Comezar a usar Simple Invoices";//1
...
$LANG['username'] = "Nome de usuario";//1
$LANG['users'] = "Users";//1
