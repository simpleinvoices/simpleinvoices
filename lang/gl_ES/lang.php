...
$LANG['add_new_tax_rate'] = "Engadir Porcentaxe de Imposto";//1
...
$LANG['customise_settings'] = "Personalizar a configuracion";//1
$LANG['dashboard'] = "Panel de control";//1
$LANG['database_backup'] = "Copia de seguranza da base de datos";//1
$LANG['database_log'] = "Rexistro da base de datos";//1
$LANG['database_upgrade_manager'] = "Xestor de actualizacions da base de datos";//1
$LANG['date'] = "data";//1
...
$LANG['debtors'] = "Debedores";//1
$LANG['debtors_by_aging_periods'] = "Debedores por periodos de antiguidade";//1
$LANG['debtors_by_amount_owed'] = "Debedores por importe debido";//1
$LANG['debtors_by_amount_owing_customer'] = "Debedores por importe debido por cliente";//1
...
$LANG['default_number_items'] = "Numero predeterminado de linhas";//1
$LANG['default_payment_type'] = "Tipo de pagamento predeterminado";//1
...
$LANG['delete_line_item'] = "Eliminar esta linha";//1
$LANG['delete_row'] = "Eliminar esta fila";//1
$LANG['deleted'] = "foi eliminado";//1
$LANG['denied_page'] = "Non tes permiso para ver esta paxina";//1
...
$LANG['displaying_inv'] = "Amosando facturas";//1
$LANG['displaying_items'] = "Amosando de {from} a {to} de {total} elementos";//1
$LANG['domain'] = "Dominio";//1
$LANG['dont_forget_to'] = "Non esquezas";//1
$LANG['draft'] = "Borrador";//1
$LANG['due'] = "Vencemento";//1
$LANG['edit'] = "Editar";//1
$LANG['edit_view_tooltip'] = "Editar";//1
$LANG['email'] = "Correo el.";//1
$LANG['email_bcc'] = "CCO";//1
$LANG['email_biller'] = "Correo do emisor";//1
$LANG['email_biller_after_cron'] = "Correo ao emisor despois de cada recorrencia";//1
$LANG['email_customer'] = "Correo do cliente";//1
$LANG['email_customer_after_cron'] = "Correo ao cliente despois de cada recorrencia";//1
$LANG['email_from'] = "Correo de";//1
$LANG['email_quick'] = "Correo el. r&aacute;//1pido";//1
$LANG['email_statement_as_pdf'] = "Enviar o extracto como PDF";//1
...
$LANG['eway_merchant_xml'] = "XML aloxado do comercio Eway";//1
...
$LANG['from'] = "De";//1
$LANG['fwrite_error'] = "Recibiches erros de fwrite()?";//1
...
$LANG['no_inventory_movements'] = "Non se rexistrou ningun movemento de inventario. Fai clic no boton superior para crear un.";//1
...
$LANG['none'] = "none";//0
$LANG['note'] = "Nota";//1
$LANG['note_as_description'] = "Usar a nota como descricion da linha";//1
$LANG['note_attributes'] = "Atributos da nota";//1
$LANG['note_expand'] = "Amosar por defecto a descricion da linha";//1
$LANG['notes'] = "Notas";//1
...
$LANG['paymentsgateway_api_id'] = "ID da API de PaymentsGateway";//1
...
$LANG['product_description_prompt'] = "Debes introducir unha descricion para o produto";//1
...
$LANG['save_eway_success'] = "Transaccion Eway correcta,<br /> seras redirixido a paxina de pagamentos";//1
...
$LANG['setup_create_invoices'] = "Comeza a crear facturas, fai clic en ";//1
...
$LANG['simple_invoices_powered_by'] = "Funciona con Simple Invoices";//1
...
$LANG['warning_eway'] = "<b>Nota:</b> estas a piques de cargar a tarxeta do teu cliente<br />- asegurate de saber o que fas.";//1
...
$LANG['years'] = "anos";//1
$LANG['yes'] = "Si";//1
$LANG['your_reports'] = "Os teus informes";//1
$LANG['zip'] = "C&oacute;digo Postal";//1
$LANG['manage_product_attributes'] = "Xestionar atributos do produto";//1
$LANG['add_product_attribute'] = "Engadir atributo do produto";//1
$LANG['insert_product_attribute'] = "Inserir atributo do produto";//1
$LANG['product_attribute'] = "Atributo do produto";//1
$LANG['add_product_value'] = "Engadir valor do produto";//1
$LANG['insert_product_value'] = "Inserir valor do produto";//1
$LANG['product_value'] = "Valor do produto";//1
$LANG['manage_product_values'] = "Xestionar valores do produto";//1

$LANG['title_module_index'] = "Inicio";//1
$LANG['title_module_reports'] = "Inicio / Informes";//1
$LANG['title_module_invoices'] = "Dineiro / Facturas";//1
$LANG['title_module_cron'] = "Dineiro / Recorrencia";//1
$LANG['title_module_payments'] = "Dineiro / Pagamentos";//1
$LANG['title_module_billers'] = "Persoas / Emisores";//1
$LANG['title_module_customers'] = "Persoas / Clientes";//1
$LANG['title_module_user'] = "Persoas / Usuarios";//1
...
$LANG['title_module_system_defaults'] = "Configuracion / Preferencias do sistema";//1
$LANG['title_module_custom_fields'] = "Configuracion / Campos personalizados";//1
$LANG['title_module_tax_rates'] = "Configuracion / Taxas";//1
$LANG['title_module_preferences'] = "Configuracion / Preferencias de factura";//1
$LANG['title_module_payment_types'] = "Configuracion / Tipos de pagamento";//1
