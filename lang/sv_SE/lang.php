...
$LANG['help_simple_invoices'] = "SimpleInvoices är ett simpelt faktureringssystem designat med enkelhet och funktionalitet i tanken. Det tillgodoser behoven för små organisationer och hemma användare.<br /><br />För mera information vänligen hänvisa till SimpleInvoices webbsida: <a href='https://simpleinvoices.group/doku.php?id=si_wiki:menu' target='_blank'><b>Simple Invoices Wiki</b></a>";//1
