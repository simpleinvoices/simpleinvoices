...
$LANG['Custom_Fields'] = "Trường mở rộng";//1
...
$LANG['end_date'] = "Ngày kết thúc (YYYY-MM-DD)";
$LANG['end_date_short'] = "Ngày kết thúc";
$LANG['eway'] = "Eway";//1
...
$LANG['save_eway_check_failed'] = "Eway transation chưa được thực hiện nó xuất hiện trong Hóa Đơn đã được trả tiền hoặc khách hàng hoặc NV Bán Hàng không có thông tin chi tiết của Eway";//1
$LANG['save_eway_success'] = "Eway transation luu thành công,<br /> hệ thống sẽ chuyễn bạn đến trang Danh sách Thanh Toán";//1
...
$LANG['start_date'] = "Ngày bắt đầu (YYYY-MM-DD)";
$LANG['start_date_short'] = "Ngày bắt đầu";
...
$LANG['thank_you_inv'] = "Cảm ơn bạn đã lập Hóa Đơn với ";
$LANG['to'] = "Đến";//1
...
$LANG['warning_eway'] = "<b>Ghi chú:</b> Bạn đang tính tiền khách hàng bằng thẻ Tín Dụng<br /> - chắc chắn bạn biết bạn cần làm gí!!";
$LANG['weeks'] = "Tuần";//1
...
$LANG['zip'] = "Mã Zip";//1
$LANG['vnd'] = "đồng";//1
$LANG['in_word'] = "Số tiền viết bằng chữ: ";//1
$LANG['print'] = "Nhấn Vào In";//1
?>
