...
$LANG['account_name'] = "Account name";//1
$LANG['account_number'] = "Account number";//1
...
$LANG['add_new_biller'] = "Add Biller";//1
$LANG['add_new_invoice'] = "Add Invoice";//1
$LANG['add_new_payment'] = "Add Payment";//1
$LANG['add_new_payment_type'] = "Add Payment Type";//1
$LANG['add_new_preference'] = "Add Preference";//1
$LANG['add_new_product'] = "Add Product";//1
$LANG['add_new_row'] = "Add new row";//1
$LANG['add_new_tax_rate'] = "Add Tax Rate";//1
...
$LANG['back'] = "Back";//1
$LANG['backed_up_successfully'] = "Backed up successfully";//1
...
$LANG['bank_account_name'] = "Bank account name";//1
$LANG['bank_account_name_hint'] = "The name on the bank account";//1
$LANG['bank_account_number'] = "Bank account number";//1
$LANG['bank_account_number_hint'] = "The bank account number or IBAN";//1
$LANG['bank_details'] = "Bank details";//1
$LANG['bank_details_hint'] = "Bank account details for payments";//1
$LANG['bank_name'] = "Bank name";//1
$LANG['bank_name_hint'] = "The name of the bank";//1
$LANG['bank_routing_sort_code'] = "Routing / Sort Code";//1
$LANG['bank_routing_sort_code_hint'] = "The bank routing or sort code";//1
$LANG['bank_swift_bic'] = "SWIFT/BIC";//1
$LANG['bank_swift_bic_hint'] = "The bank SWIFT or BIC code";//1
...
$LANG['city'] = "City";//1
$LANG['close'] = "Close";//1
$LANG['configured'] = "Configured";//1
$LANG['confirm_delete'] = "Are you sure you want to delete";//1
$LANG['contact_person'] = "Contact Person";//1
$LANG['contacts'] = "Contacts";//1
$LANG['contacts'] = "Contacts";//1
$LANG['copied'] = "Copied!";//1
$LANG['copy_sql'] = "Copy SQL";//1
$LANG['cost'] = "Cost";//1
$LANG['cost_price'] = "Cost Price";//1
...
$LANG['default_currency'] = "Default currency";//1
...
$LANG['database_tools'] = "Database tools";//1
...
$LANG['default_payment_terms'] = "Default payment terms";//1
...
$LANG['electronic_funds_transfer'] = "Electronic Funds Transfer";//1
$LANG['email'] = "Email";//1
...
$LANG['email_invoice_as_pdf'] = "Email %s to Customer as PDF";//1
...
$LANG['essential_data_installed'] = "Essential data installed";//1
$LANG['eway'] = "Eway";//1
...
$LANG['extensions_removed'] = "Extensions have been removed from this installation. Only the core application is supported.";//1
...
$LANG['first_run_intro'] = "Welcome! Complete these steps to start invoicing:";//1
$LANG['for'] = "for";//1
$LANG['footer_token_hint'] = "Tokens are replaced with live values when the invoice is rendered. Use {lang.*} for labels and {biller.*}, {customer.*}, {invoice.*} for values.";//1
...
$LANG['grid_connection_error'] = "Connection error";//1
$LANG['grid_invalid_xml'] = "Invalid XML response";//1
$LANG['grid_records'] = "records";//1
$LANG['grid_reload'] = "Reload";//1
$LANG['grid_search'] = "Search";//1
$LANG['grid_search_placeholder'] = "Search";//1
$LANG['grid_sort_by'] = "Sort by {column}";//1
...
$LANG['help_invoice_currency'] = "The currency you select here will be used for all amounts on this invoice. The currency dropdown includes all currencies configured in your system under Settings → Manage Currencies.<br /><br />When you select an Invoice Preference, the currency automatically updates to match that preference's default currency. You can still override it manually for individual invoices if needed.<br /><br />The currency sign (e.g. $, &amp;#8364;, &amp;#163;) and 3-letter currency code (e.g. USD, EUR, GBP) are both stored with the invoice and used for display and online payment processing.";//1
...
$LANG['help_invoice_id'] = "The Invoice ID is <b>automatically generated</b> and is made up of 3 parts combined together:<br /><br /><b>1. Biller Invoice Prefix</b> — set on each Biller (Settings → Billers). Example: 'B1-', 'NY-'<br /><br /><b>2. Invoice Preference Prefix</b> — set on the Invoice Preference (Settings → Invoice Preferences). Example: 'INV-', 'QTE-', 'REC-'<br /><br /><b>3. Auto-incrementing Number</b> — a sequential number managed by the system, optionally zero-padded using a format like %06d (6-digit = 000042) or %04d (4-digit = 0042)<br /><br /><b>Full ID example:</b> B1-INV-000042<br />(Biller prefix 'B1-' + Preference prefix 'INV-' + formatted number '000042')<br /><br /><b>HOW NUMBERING GROUPS WORK:</b><br /><br />Each Invoice Preference belongs to a <i>numbering group</i> (index_group). Invoices using preferences in the <i>same group</i> share a single sequential counter — meaning your Invoice #1 and Receipt #2 could be from different preference groups sharing one counter. Invoices using preferences in <i>different groups</i> get separate independent counters.<br /><br /><b>Example: Separate Groups</b><br />• Preference 'Invoice' → Group 1 → IDs: INV-1, INV-2, INV-3...<br />• Preference 'Quote' → Group 2 → IDs: QTE-1, QTE-2, QTE-3...<br />• Preference 'Receipt' → Group 3 → IDs: REC-1, REC-2, REC-3...<br /><br /><b>Example: Shared Group</b><br />• Preference 'Invoice' → Group 1<br />• Preference 'Receipt' → Group 1<br />→ IDs would be interleaved: INV-1, REC-2, INV-3, REC-4...<br /><br /><b>Example: Combined with Biller Prefix</b><br />• Biller 'NY Office' prefix = 'NY-'<br />• Preference 'Invoice' prefix = 'INV-', group 1, format %04d<br />→ IDs: NY-INV-0001, NY-INV-0002...<br />• Biller 'CA Office' prefix = 'CA-'<br />• Same Preference 'Invoice' → IDs: CA-INV-0003, CA-INV-0004...<br /><br /><b>Where to configure:</b><br />• Biller Prefix: Settings → Billers → edit a biller → 'Invoice Prefix'<br />• Preference Prefix &amp; Format: Settings → Invoice Preferences → edit a preference → 'Invoice ID Prefix' and 'Invoice ID Format'<br />• Numbering Group: Settings → Invoice Preferences → edit a preference → 'Numbering Group'<br /><br /><b>Note:</b> The Invoice ID shown during creation is a <i>preview</i> of what will be assigned. The actual number is only committed when you save the invoice. Since multiple users may create invoices at the same time, your final ID could differ from the preview.";//1
$LANG['help_invoice_preference'] = "Invoice Preferences define the wording, currency, payment terms, and numbering settings for your invoices. You can create as many as you need — one for Invoices, one for Quotes, one for Receipts, etc.<br /><br />When you select a preference here:<br />• The <b>currency</b> automatically updates to match<br />• The <b>payment terms</b> auto-fill if set<br />• The <b>Invoice ID</b> preview updates based on the preference's numbering group, prefix, and format<br /><br />To create or edit preferences, go to <b>Settings → Invoice Preferences</b>.";//1
...
$LANG['help_options_menu'] = "For information regarding the setup, installation, and use of %s please refer to the Instructions sub-menu in the Options menu.";//1
$LANG['help_other_queries'] = "For other queries please refer to the %s website %s and the %s forum at %s";//1
...
$LANG['install_database_and_essential'] = "Install database and essential data";//1
$LANG['install_documentation'] = "installation documentation";//1
$LANG['install_essential_done'] = "The Simple Invoices essential data has been imported. You can now start using Simple Invoices.";//1
$LANG['install_help'] = "If you have any problems or queries regarding installation please refer to the";//1
$LANG['install_intro'] = "Simple Invoices works with MySQL, MariaDB, PostgreSQL, or SQLite. Create a database, point the app at it, then finish setup below.";//1
$LANG['install_sample_data'] = "Install sample data";//1
$LANG['install_sample_optional'] = "Optionally, you can install sample data (demo invoices, customers, products) to explore the application.";//1
$LANG['install_setup_done'] = "The database and essential data have been installed. You can now start using Simple Invoices.";//1
$LANG['install_step_config'] = "Point the app at the database";//1
$LANG['install_step_db'] = "Create an empty database";//1
$LANG['install_step_review'] = "Install schema and sign in";//1
...
$LANG['invoice_payment_line_0_name'] = "Invoice payment line 0 name";//1
$LANG['invoice_payment_line_0_value'] = "Invoice payment line 0 value";//1
...
$LANG['invoice_payment_line_3_name'] = "Invoice payment line 3 name";//1
$LANG['invoice_payment_line_3_value'] = "Invoice payment line 3 value";//1
$LANG['invoice_payment_line_4_name'] = "Invoice payment line 4 name";//1
$LANG['invoice_payment_line_4_value'] = "Invoice payment line 4 value";//1
$LANG['invoice_payment_line_5_name'] = "Invoice payment line 5 name";//1
$LANG['invoice_payment_line_5_value'] = "Invoice payment line 5 value";//1
...
$LANG['invoice_reference'] = "Invoice reference";//1
$LANG['invoice_settings'] = "Invoice settings";//1
$LANG['invoice_start'] = "Invoice Start";//1
$LANG['invoice_status'] = "Invoice status";//1
...
$LANG['manage_accounts'] = "Manage users";//1
...
$LANG['new'] = "New";//1
$LANG['next_invoice_number'] = "Next invoice number";//1
$LANG['invoice_id_prefix'] = "Invoice ID Prefix";//1
$LANG['invoice_id_format'] = "Invoice Number Format";//1
$LANG['invoice_id_format_help'] = "PHP sprintf format for the numeric part of the invoice ID. Use %06d for 6-digit zero-padded numbers (000345), %08d for 8-digit, etc. Leave empty for no padding.";//1
...
$LANG['payment_line0_name'] = "Bank name";//1
$LANG['payment_line0_value'] = "Bank name value";//1
$LANG['payment_line3_name'] = "Account number";//1
$LANG['payment_line3_value'] = "Account number value";//1
$LANG['payment_line4_name'] = "SWIFT/BIC";//1
$LANG['payment_line4_value'] = "SWIFT/BIC value";//1
$LANG['payment_line5_name'] = "Invoice reference";//1
$LANG['payment_line5_value'] = "Invoice reference value";//1
$LANG['payment_processors_add_note'] = "Online payment processors can be added in the Biller settings.";//1
$LANG['payment_token_hint'] = "Tokens are replaced with live values when the invoice is rendered. Use {lang.*} for labels and {biller.*}, {customer.*}, {invoice.*} for values.";//1
...
$LANG['preference_description_required'] = "You must enter a description for the preference";//1
...
$LANG['profit_per_invoice_summary'] = "Profit per invoice based on average product cost summary for the period {start_date} to {end_date}";//1
...
$LANG['rate'] = "Rate";//1
$LANG['real'] = "Real";//1
$LANG['receipt'] = "Receipt";//1
$LANG['recent_invoices'] = "Recent Invoices";//1
$LANG['recent_payments'] = "Recent Payments";//1
...
$LANG['sample_data_done'] = "Sample data has been imported into Simple Invoices. You will be redirected in a few seconds, or click below to continue.";//1
$LANG['sample_data_error'] = "Sample data import failed";//1
$LANG['sample_data_error_msg'] = "Something went wrong. Sample data has NOT been imported into Simple Invoices.";//1
$LANG['sample_data_installed'] = "Sample data installed";//1
$LANG['sanity_check'] = "Sanity check of invoices";//1
$LANG['sanity_check_wip'] = "This feature is still a work in progress, please refer to our homepage: %s for updates.";//1
...
$LANG['setup_complete'] = "Setup complete";//1
...
$LANG['setup_database'] = "Set up database";//1
$LANG['shortcut'] =" Shortcut menu";//1
$LANG['show_all'] = "Show all";//1
...
$LANG['start_using_simple_invoices'] = "Start using Simple Invoices";//1
$LANG['start_working'] = "Start working";//1
$LANG['starting_invoice_number'] = "Starting invoice number";//1
$LANG['state'] = "State";//1
...
$LANG['switch_to_dark_mode'] = "Switch to dark mode";//1
$LANG['switch_to_light_mode'] = "Switch to light mode";//1
$LANG['swift_bic'] = "SWIFT/BIC";//1
...
$LANG['toggle_navigation'] = "Toggle navigation";//1
...
$LANG['wizard_add_a_customer'] = "Add a Customer";//1
$LANG['wizard_add_a_product'] = "Add a Product or Service";//1
$LANG['wizard_add_your_details'] = "Add Your Details";//1
$LANG['wizard_all_invoices'] = "All Invoices";//1
$LANG['wizard_all_set'] = "You're all set up and invoicing!";//1
$LANG['wizard_all_set_tagline'] = "Head to the invoice list to see your invoices, or create another one.";//1
...
$LANG['wizard_bank_token_hint'] = "Tokens like {biller.bank_name} and {biller.bank_account_number} will be replaced with your biller details on the invoice.";//1
$LANG['wizard_biller_ready'] = "Your billing details are set up!";//1
$LANG['wizard_biller_ready_tagline'] = "Your biller is ready. You can update your details any time.";//1
$LANG['wizard_business_name'] = "Business / Your Name";//1
$LANG['wizard_create_first_invoice'] = "Create Your First Invoice";//1
$LANG['wizard_create_invoice'] = "Create Invoice";//1
...
$LANG['wizard_customer_ready'] = "At least one customer is set up!";//1
$LANG['wizard_customer_ready_tagline'] = "You can add more customers any time.";//1
$LANG['wizard_done_badge'] = "Done";//1
$LANG['wizard_full_biller_form'] = "Full biller form (more options)";//1
$LANG['wizard_full_customer_form'] = "Full customer form (more options)";//1
$LANG['wizard_full_product_form'] = "Full product form (more options)";//1
...
$LANG['wizard_prefills_form'] = "Pre-fills the form - edit before saving.";//1
$LANG['wizard_prereqs_biller'] = "Add your billing details (Step 1)";//1
$LANG['wizard_prereqs_customer'] = "Add a customer (Step 2)";//1
$LANG['wizard_prereqs_intro'] = "Before creating an invoice you need to complete the earlier steps:";//1
$LANG['wizard_prereqs_product'] = "Add a product or service (Step 3)";//1
...
$LANG['wizard_product_ready'] = "At least one product / service is set up!";//1
$LANG['wizard_product_ready_tagline'] = "You can add more products or services any time.";//1
$LANG['wizard_ready_click_below'] = "Click the button below to open the new invoice form.";//1
$LANG['wizard_ready_tagline'] = "Your biller, customer, and products are all set.";//1
$LANG['wizard_ready_to_go'] = "Ready to go!";//1
$LANG['wizard_sample_added'] = "Sample data added - taking you to the next step…";//1
$LANG['wizard_sample_failed'] = "Could not add sample data. Please try again or fill in the form manually.";//1
$LANG['wizard_sample_replace_later'] = "You can edit or replace sample data later.";//1
$LANG['wizard_save_details'] = "Save Your Details";//1
$LANG['wizard_starting_number_hint'] = "The number from which new invoices in this group will start.";//1
$LANG['wizard_state_region'] = "State / Region";//1
$LANG['wizard_try_sample'] = "Just want to try it out first?";//1
$LANG['wizard_use_sample_biller'] = "Use sample biller data";//1
...
// Database backup / JSON export-import (options/backup_database)
...
$LANG['tax_id_tab_label'] = "Tax IDs";
$LANG['tax_id_label_1'] = "Tax ID Type";
$LANG['tax_id_name_1'] = "Tax ID Number";
$LANG['tax_id_label_2'] = "Additional ID Type";
$LANG['tax_id_name_2'] = "Additional ID Number";
$LANG['tax_id_label_placeholder'] = "e.g. EIN, VAT, ABN";
$LANG['tax_id_name_placeholder'] = "Enter tax ID number";
$LANG['tax_id_label_2_placeholder'] = "e.g. State Tax ID (USA), SIRET (France), CRN (UK), CIF (Spain), KVK (Netherlands)";
$LANG['tax_id_name_2_placeholder'] = "Enter additional ID number";
$LANG['tax_id_type_au'] = "ABN";
$LANG['tax_id_type_br'] = "CNPJ";
$LANG['tax_id_type_ca'] = "Business Number";
$LANG['tax_id_type_de'] = "USt-IdNr.";
$LANG['tax_id_type_es'] = "NIF";
$LANG['tax_id_type_fr'] = "Numéro TVA";
$LANG['tax_id_type_gb'] = "VAT Registration Number";
$LANG['tax_id_type_it'] = "Partita IVA";
$LANG['tax_id_type_nl'] = "BTW-nummer";
$LANG['tax_id_type_us'] = "EIN";
$LANG['tax_id_type_us_secondary'] = "State Tax ID";
$LANG['tax_id_type_gb_secondary'] = "CRN (Company Registration Number)";
$LANG['tax_id_type_au_secondary'] = "ACN";
$LANG['tax_id_type_ca_secondary'] = "GST/HST Number";
$LANG['tax_id_type_de_secondary'] = "Handelsregisternummer";
$LANG['tax_id_type_fr_secondary'] = "SIRET";
$LANG['tax_id_type_es_secondary'] = "CIF";
$LANG['tax_id_type_it_secondary'] = "Codice Fiscale";
$LANG['tax_id_type_nl_secondary'] = "KVK-nummer";
$LANG['tax_id_type_br_secondary'] = "Inscrição Estadual";
