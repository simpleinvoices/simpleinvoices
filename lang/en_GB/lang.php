...
$LANG['install_intro'] = "To install Simple Invoices please:";//1
...
$LANG['install_step_config'] = "Enter the correct database connection details in the config/config.php file";//1
...
$LANG['wizard_invoice_preferences'] = "Invoice preferences";//1
...
$LANG['wizard_invoice_prefs_note'] = "Full invoice wording, language, locale, date formatting, and currency code are configured in Invoice Preferences (Settings).";//1
$LANG['wizard_bank_details_optional'] = "Bank details are optional. Add them now if you want them ready for bank transfer instructions on invoices.";//1
