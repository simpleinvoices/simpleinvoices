...
$LANG_address_street = "Enderezo: r�a, lugar, etc";//1
...
$LANG_product_description = "Descrici�n de Produto";//1
...
$LANG_tax = "Imposto";//1
$LANG_tax_description = "Descrici�n do Imposto";//1
...
$LANG['total_style'] = "en estilo Total";
