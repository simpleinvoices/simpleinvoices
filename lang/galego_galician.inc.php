...
$LANG['included'] = "inclu&iacute;//1do";//1
...
$LANG['inv'] = "Factura";//1
$LANG['inv_consulting'] = " - An&aacute;//1lise";//1
...
$LANG['invoice_detail_line'] = "Detalle de Li&ntilde;//1a de factura";//1
$LANG['invoice_footer'] = "P&eacute;//1 de factura";//1
$LANG['invoice_heading'] = "Cabeceira de factura";//1
$LANG['invoice_id'] = "ID de Factura";//1
$LANG['invoice_listings'] = "Listado de Factura";//1
$LANG['invoice_payment_line_1_name'] = "Li&ntilde;//1a 1 nome de factura de pagamento";//1
$LANG['invoice_payment_line_1_value'] = "Li&ntilde;//1 1 valor de factura de pagamento";//1
$LANG['invoice_payment_line_2_name'] = "Li&ntilde;//1a 2 nome de factura de pagamento";//1
$LANG['invoice_payment_line_2_value'] = "Li&ntilde;//1a 2 valor de factura de pagamento";//1
$LANG['invoice_payment_method'] = "M&eacute;//1todo de pagamento de factura";//1
...
$LANG['manage_customers'] = "Xesti&oacute;//1n de Clientes";//1
$LANG['manage_invoices'] = "Xesti&oacute;//1n de Facturas";//1
$LANG['manage_invoice_preferences'] = "Manage Invoice Preferences";//0
$LANG['manage_payment_types'] = "Xesti&oacute;//1n de Tipos de Aboamento";//1
$LANG['manage_payments'] = "Manage Payments";//0
$LANG['manage_preferences'] = "Xesti&oacute;//1n de Preferencias";//1
$LANG['manage_products'] = "Xesti&oacute;//1n de Produtos";//1
$LANG['manage_tax_rates'] = "Xesti&oacute;//1n de Porcentaxes de Imposto";//1
$LANG['mandatory_fields'] = "Todos os campos son obrigados";//1
$LANG['mobile_phone'] = "Tel&eacute;//1fono M&oacute;//1";//1
...
$LANG['no_preferences'] = "Non hai preferencias de facturaci&oacute;//1n na base de datos, engada algunha";//1
$LANG['no_tax_rates'] = "Non hai  Porcentaxes de Taxas na base de datos, engda algunha";//1
$LANG['note'] = "Nota";//1
$LANG['notes'] = "Notas";//1
$LANG['notes_opt'] = "Notas (opcional)";//1
$LANG['number_short'] = "N&uacute;//1m.";//1
$LANG['owing'] = "Xerado";//1
...
$LANG['payment_type_method'] = "Tipo/M&eacute;//1todos de pagametno";//1
...
$LANG['provision_of'] = "Provisi&oacute;//1n de";//1
$LANG['quick_view_of'] = "Esta &eacute;//1 un Vista R&aacute;//1pida de";//1
$LANG['quick_view_tooltip'] = "Vista r&aacute;//1pida de";//1
...
$LANG['tax_total'] = "Imposto total inclu&iacute;//1do";//1
...
$LANG['zip'] = "C&oacute;//1digo Postal";//1


#Index.php - front page


$LANG['shortcut'] ="Men&uacute;//1 de atallos";//1

$LANG['getting_started'] ="Comezando";//1
$LANG['faqs_what'] ="Que &eacute;//1 Factura Simple?";//1
...
$LANG['options'] ="Opci&oacute;//1ns";//1

$LANG['stats'] =" Estat&iacute;//1sticas r&aacute;//1pidas";//1
