...
$LANG['tax_id'] = "ID daňové";//1
$LANG['tax_percentage'] = "Procento dan?";//1
$LANG['tax_rate'] = "Sazba daňová";//1
$LANG['tax_rate_details'] = "Podrobnosti sazby dan?";//1
$LANG['tax_rate_id'] = "ID sazby daňová";//1
$LANG['tax_rate_to_add'] = "Sazba dan? k p?idání";//1
$LANG['tax_rates'] = "Sazby daňové";//1
$LANG['tax_total'] = "Celkem daňová";//1
...
$LANG['title_module_index']				= "Domů";//1
