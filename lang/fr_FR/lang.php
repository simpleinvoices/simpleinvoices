...
$LANG['help_backup_database_fwrite'] = "<b>Des erreurs de fwrite()?</b><br />Si vous voyez des erreurs fwrite() quand vous essayez de sauvegarder la base de données Simple Invoices, c'est parce que l'utilisateur du serveur web (genre Apache) n'a pas les droits de lecture et d'écriture sur le dossier tmp/database_backups dans le répertoire de Simple Invoices.<br /><br />Veuillez changer les permissions dans ce dossier avant de réessayer une sauvegarde.  Pour changer la permission du dossier tmp/database_backups sous Unix/Linix/OSX, utiliser cd pour vous rendre dans le dossier de Simple Invoice (<i>cd /var/www/html/simpleinvoices</i>) puis utiliser la commande chmod pour donner à l'utilisateur du serveur web les droits en  lecture et écriture (<i>chmod -Rv 777 tmp/database_backups</i>)";//1
