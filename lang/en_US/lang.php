...
$LANG['email_invoice_as_pdf'] = "Email Invoice to Customer as PDF";//1
...
$LANG['help_options_menu'] = "For information regarding the setup, installation, and use of %s please refer to the Instructions sub-menu in the Option menu.";//1
...
$LANG['install_database_and_essential'] = "Install database & essential data";//1
$LANG['install_documentation'] = "install documentation";//1
...
$LANG['install_help'] = "If you have any problems or queries re installation please refer to the";//1
...
$LANG['install_new_domain_setup_intro'] = "Click the button below to create the default preferences, tax, and other essentials for this organization. This only takes a moment.";//1
...
$LANG['ui_language_domain_default'] = "Use organization default";//1
$LANG['ui_language_account_hint'] = "Leave blank to use the organization default language.";//1
...
$LANG['wizard_biller_description'] = "A Biller represents you or your business - the entity that creates and sends invoices. Your name, address, and contact info will appear on every invoice you generate.";//1
...
$LANG['wizard_sample_added'] = "Sample data added - taking you to the next step\u{2026}";//1
