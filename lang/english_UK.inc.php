...
$LANG_add_new_payment_type = "Add New payment Type";
...
$LANG_date= "date";
$LANG_date_created = "Date created";
$LANG_date_formatted = "Date (YYYY-MM-DD)";
$LANG_days = "days";
$LANG_description = "Description";
$LANG_details = "Details";
$LANG_edit = "Edit";
$LANG_edit_view_tooltip = "Edit";
$LANG_email = "Email";
$LANG_email_quick = "Quick Email";
$LANG_export_as = "Export as";
$LANG_export_doc_tooltip = "to a word processor as";
$LANG_export_pdf = "Export to PDF";
$LANG_export_pdf_tooltip = "as PDF format";
$LANG_export_tooltip = "Export"; 
$LANG_export_xls_tooltip = "to a spreadsheet as";
$LANG_fax = "Fax";
$LANG_format_tooltip = "format";
$LANG_gross_total = "Gross";
...
$LANG_inv_pref = "Prefer&egrave;ncies Factura";
...
$LANG_invoice_summary = "Invoice Summary";
$LANG_invoice_type = "Type";
...
$LANG_manage_customers = "Manage Customers";
...
$LANG_no_customers = "There are no customers in the database, please add one";
...
$LANG_quick_view_tooltip = "Quick View of"; 
$LANG_save = "Save";
