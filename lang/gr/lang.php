...
$LANG['export_tooltip'] = "Εξαγωγή_Εργαλεία Βοήθειας";//1
$LANG['export_xls_tooltip'] = "Εξαγωγή σε Excel_Εργαλεία Βοήθειας";//1
...
$LANG['help'] = "Βοήθεια";//1
$LANG['help_manage_invoices'] = "Βοήθεια Διαχείρησης Τιμολογίων";//1
...
$LANG['mobile_short'] = "Ταξινόμηση Κινητών Τηλεφώνων";//1
...
$LANG['no_billers'] = "Δεν Υπάρχουν Πωλητές";//1
$LANG['no_customers'] = "Δεν Υπάρχουν Πελάτες";//1
$LANG['no_defaults'] = "Δεν Υπάρχουν Προεπιλογές";//1
$LANG['no_invoices'] = "Δεν Υπάρχουν Τιμολόγια";//1
$LANG['no_payment_types'] = "Δεν Υπάρχουν Τρόποι Πληρωμής";//1
$LANG['no_payments'] = "Δεν Υπάρχουν Πληρωμές";//1
$LANG['no_preferences'] = "Δεν υπάρχουν ρυθμίσεις";//1
$LANG['no_products'] = "Δεν Υπάρχουν Προϊόντα";//1
$LANG['no_tax_rates'] = "Δεν Υπάρχουν Φορολογικοί Συντελεστές";//1
...
$LANG['payments_filtered_customer'] = "Φιλτραρισμένες Πληρωμές Πελατών";//1
$LANG['payments_filtered_invoice'] = "Φιλτραρισμένες Πληρωμές_Τιμολόγιο";//1
...
$LANG['print_preview_tooltip'] = "Προεπισκόπηση Εκτύπωσης_Εργαλεία Βοήθειας";//1
...
$LANG['quick_view_of'] = "Γρήγορη Ματιά";//1
$LANG['quick_view_tooltip'] = "Γρήγορη Ματιά_Εργαλεία Βοήθειας";//1
...
$LANG['total_uppercase'] = "Σύνολο των Παραπάνω";//1
...
$LANG['wheres_the_edit_button'] = "Που είναι το Πλήκτρο Εισαγωγής Στοιχείων";//1
$LANG['zip'] = "Ταχ. Κωδ.";//1
