...
$LANG['add_invoice_item'] = "Legg til fakturaprodukt";//0
$LANG['add_invoice_preference'] = "Legg til fakturamal";//1
...
$LANG['add_new_preference'] = "Legg til ny fakturamal";//1
...
$LANG['backup_database_now'] = "SIKKERHETSKOPIER DATABASE NÅ";//1
$LANG['backup_done'] = "Din database er sikkerhetskopiert til %s, du kan nå fortsette med din daglige drift.";//1
...
$LANG['biller_name'] = "Operatørens navn";//1
$LANG['biller_sales'] = "Salgsoperatører";//1
...
$LANG['cannot_delete_first_row'] = "Første rad kunne ikke fjernes";//1
$LANG['change_log'] = "Endringslogg";//1
$LANG['city'] = "By";//1
$LANG['confirm_delete'] = "Er du sikker på at du vil fjerne";//1
...
$LANG['database_upgrade_manager'] = "Verktøy for oppgradering av database";//1
$LANG['date'] = "dato";//1
...
$LANG['default_invoice_preference'] = "Standard fakturainstillinger";//1
$LANG['default_number_items'] = "Standard antall av linje punkter:";//1
$LANG['default_payment_type'] = "Standard betalingsform";//1
$LANG['default_tax'] = "Standard skatt";//1
$LANG['delete'] = "Slett";//1
$LANG['denied_page'] = "Du har ingeng tilgang til denne siden";//1
...
$LANG['email'] = "E-post";//1
$LANG['email_bcc'] = "E-post BCC (Blindkopi)";//1
$LANG['email_from'] = "E-post from";//1
$LANG['email_to'] = "E-post til";//1
$LANG['email_quick'] = "Hurtig E-post";//1
$LANG['enabled'] = "Aktivert";//1
$LANG['export_as'] = "Eksporter som";//1
$LANG['export_doc'] = "Exporter til DOC";//1
...
$LANG['export_xls'] = "Exporter til XLS";//1
...
$LANG['for'] = "for";//1
$LANG['from'] = "Fra";//1
$LANG['fwrite_error'] = "Fikk du fwrite feilmelding?";//1
...
$LANG['home'] = "Hjem";//1
$LANG['id'] = "ID";//1
$LANG['ie_10_for_10'] = "* f.eks 25 for 25%";//1
...
$LANG['inv_pref'] = "Fakturainstillinger";//1
$LANG['inv_pref_short'] = "Pref";//0
$LANG['inv_total'] = " - Sum";//1
$LANG['invoice'] = "Faktura";//1
$LANG['invoice_create'] = "Opprett faktura";//1
$LANG['invoice_detail_heading'] = "Heading med fakturadetaljer";//1
$LANG['invoice_detail_line'] = "Linje med fakturadetaljer";//1
...
$LANG['invoice_preference_to_add'] = "Fakturainstillinger å legge til";//1
$LANG['invoice_preferences'] = "Fakturainstillinger";//1
$LANG['invoice_start'] = "Start fakturering";//1
...
$LANG['manage_invoice_preferences'] = "Behandle fakturainstillinger";//1
...
$LANG['monthly_sales_per_year'] = "Månedlige salg og innbetalinger pr. år.";//1
$LANG['money'] = "Penger";//1
$LANG['name'] = "Navn";//1
$LANG['new_invoice'] = "Ny faktura";//1
$LANG['new_invoice_consulting'] = "Ny faktura - konsultasjon";//1
$LANG['new_invoice_itemised'] = "Ny faktura - artikkelbasert";//1
...
$LANG['number_of_taxes_per_line_item'] = "Antall avgifter pèr linje";//1
...
$LANG['payments_filtered'] = "Sorter betalinger etter faktura ID";//1
$LANG['payments_filtered_customer'] = "Sorter betalinger etter kunde";//0
$LANG['payments_filtered_invoice'] = "Behandle betaling for denne faktura";//1
$LANG['people'] = "Folk";//1
$LANG['phone'] = "Telefon";//1
$LANG['phone_short'] = "Tlf.";//1
$LANG['preference'] = "Innstilling";//1
...
$LANG['process'] = "Behandle";//1
$LANG['process_payment'] = "Behandle betaling";//1
$LANG['process_payment_details'] = "Behandle betalingsdetaljer";//1
$LANG['process_payment_for'] = "Behandle betaling for";//1
$LANG['process_payment_inv_id'] = "Behandle faktura ID for betaling";//1
$LANG['process_payment_auto_amount'] = "Behandle automatisk beløp for betaling";//1
$LANG['product'] = "Produkt";//1
$LANG['product_description'] = "Produktbeskrivelse";//1
$LANG['product_edit'] = "Rediger produkt";//1
$LANG['product_enabled'] = "Produkt er aktivert";//1
