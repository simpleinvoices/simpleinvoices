...
$LANG['eway'] = "eway";//1
$LANG['eway_merchant_xml'] = "eway merchant xml";//0
...
$LANG['help_cost'] = "help_cost";//0
$LANG['help_currency_code'] = "help_currency_code";//0
...
$LANG['help_inv_pref_invoice_detail_heading'] = "Tento text sa zobrazí nad podrobnými detailami faktúry";//0
...
$LANG['help_inv_pref_locale'] = "Vyberte jazyk pre faktúru";//0
...
$LANG['help_inv_pref_status'] = "help_inv_pref_status";//0
...
$LANG['help_si_help'] = "SimpleInvoices";//0
...
$LANG['help_wheres_the_edit_button'] = "In the Manage Payment screen there is no 'Edit' button. This is to provide a proper 'audit trail' of payments recorded in Simple Invoices.<br /><br />If you've made a mistake with a payment entry the best option is to reverse the entry and entery it again correctly<br /><br />Reverse the entry - what the?<br /> This basically means just doing a negative entry for the same amount as the original entry.<br /><br />ie.<br />If your entered $110<br />but you should of entered $1100<br />to reverse this entry enter -$110 against the same invoice and then enter the correct amount of $1100";//0
...
$LANG['no_crons'] = "Žiadne opakovania";//0
...
$LANG['paypal_notify_url'] = "Paypal adresa pre upozornenie";//0
$LANG['paypal_return_url'] = "Paypal adresa pre návrat";//0
$LANG['people'] = "Ľudia";//1
...
$LANG['save_eway_failure'] = "save_eway_failure";//0
$LANG['save_eway_check_failed'] = "save_eway_check_failed";//0
$LANG['save_eway_success'] = "save_eway_success";//0
...
$LANG['setup_as_biller'] = "setup_as_biller";//0
...
$LANG['simple_invoices_powered_by'] = "Simple Invoices powered by";//0
...
$LANG['warning_eway'] = "warning_eway";//0
$LANG['weeks'] = "týždne";//1
