...
$LANG['fax'] = "Fax";//1
$LANG['filter_by_dates'] = "Fitler by dates"; //1
...
$LANG['help_inv_pref_status'] = "A prference can can a status of 'Draft' or 'Open'.  Draft indicates that this is a similar to a quote and is not included in the sales reports. Open means that is a real invoice and is included in the sales reports.";//1
