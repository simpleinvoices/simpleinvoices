...
$sql ='INSERT INTO si_customers values ("","' . $c_attention . '", "' . $c_name . '", "' . $c_street_address . '", "' . $c_city . '", "' . $c_state . '", "' . $c_zip_code . '", "' . $c_country . '", "' . $c_phone . '", "' . $c_fax . '", "' . $c_email . '", "' . $c_enabled . '")';
...
#edit customer
        ...
        if ($_POST['action'] === "Save Customer") {
                $sql = "UPDATE si_customers SET c_name = '$_POST[c_name]', c_attention = '$_POST[c_attention]',c_street_address = '$_POST[c_street_address]', c_city = '$_POST[c_city]',c_state = '$_POST[c_state]',c_zip_code = '$_POST[c_zip_code]',c_country = '$_POST[c_country]', c_phone = '$_POST[c_phone]', c_fax = '$_POST[c_fax]', c_email = '$_POST[c_email]', c_enabled = '$_POST[c_enabled]'  WHERE  c_id = " . $_GET['submit'];
                if (mysql_query($sql, $conn)) {
...
#op=pay_invoice means the user came from the process_paymen page 
	...
	$sql = "INSERT into si_account_payments values ('','$_POST[ac_inv_id]','$_POST[ac_amount]','$_POST[ac_notes]','$_POST[ac_date]','$_POST[ac_payment_type]')";
...
#insert biller
 	...
 	$sql = "INSERT into si_biller values ('','$_POST[b_name]','$_POST[b_street_address]','$_POST[b_city]','$_POST[b_state]','$_POST[b_zip_code]','$_POST[b_country]','$_POST[b_phone]','$_POST[b_mobile_phone]','$_POST[b_fax]','$_POST[b_email]','$_POST[b_co_logo]','$_POST[b_co_footer]','$_POST[b_enabled]'  )";
...
#edit biller
        ...
        if ($_POST[action] == "Save Biller") {
                $sql = "UPDATE si_biller SET b_name = '$_POST[b_name]', b_street_address = '$_POST[b_street_address]', b_city = '$_POST[b_city]',b_state = '$_POST[b_state]',b_zip_code = '$_POST[b_zip_code]',b_country = '$_POST[b_country]', b_phone = '$_POST[b_phone]', b_mobile_phone = '$_POST[b_mobile_phone]', b_fax = '$_POST[b_fax]', b_email = '$_POST[b_email]', b_co_logo = '$_POST[b_co_logo]', b_co_footer = '$_POST[b_co_footer]' , b_enabled = '$_POST[b_enabled]'   WHERE  b_id = '$_GET[submit]'";
                if (mysql_query($sql, $conn)) {
...
$sql = "INSERT into si_products values ('','$_POST[prod_description]','$_POST[prod_unit_price]','$_POST[prod_enabled]' )"; 
if (mysql_query($sql, $conn)) {
...
mysql_select_db("$db_name",$conn);
	...
	if ($_POST[action] == "Save Product") {
		$sql = "UPDATE si_products SET prod_description = '$_POST[prod_description]', prod_enabled = '$_POST[prod_enabled]', prod_unit_price = '$_POST[prod_unit_price]' WHERE  prod_id = '$_GET[submit]'";
		if (mysql_query($sql, $conn)) {
...
$sql = "INSERT into si_tax values ('','$_POST[tax_description]','$_POST[tax_percentage]','$_POST[tax_enabled]')";
if (mysql_query($sql, $conn)) {
...
mysql_select_db("$db_name",$conn);
        ...
        if ( $_POST['action'] === 'Save Tax Rate' ) {
                $sql = "UPDATE si_tax SET tax_description = '$_POST[tax_description]', tax_percentage = '$_POST[tax_percentage]',tax_enabled = '$_POST[tax_enabled]'   WHERE  tax_id = " . $_GET['submit'];
...
$sql = "INSERT into si_payment_types values ('','$_POST[pt_description]','$_POST[pt_enabled]')";
if (mysql_query($sql, $conn)) {
...
mysql_select_db("$db_name",$conn);
        ...
        if ( $_POST['action'] === 'Save Payment Type' ) {
                $sql = "UPDATE si_payment_types SET pt_description = '$_POST[pt_description]',pt_enabled = '$_POST[pt_enabled]'   WHERE  pt_id = " . $_GET['submit'];
...
$sql = "INSERT into si_preferences values ('','$_POST[p_description]','$_POST[p_currency_sign]','$_POST[p_inv_heading]','$_POST[p_inv_wording]','$_POST[p_inv_detail_heading]','$_POST[p_inv_detail_line]','$_POST[p_inv_payment_method]','$_POST[p_inv_payment_line1_name]','$_POST[p_inv_payment_line1_value]','$_POST[p_inv_payment_line2_name]','$_POST[p_inv_payment_line2_value]','$_POST[pref_enabled]' )";
...
#edit preference
        ...
        if (  $_POST['action'] === 'Save Preference' ) {
                $sql = "UPDATE si_preferences SET pref_description = '$_POST[pref_description]', pref_currency_sign = '$_POST[pref_currency_sign]', pref_inv_heading = '$_POST[pref_inv_heading]', pref_inv_wording = '$_POST[pref_inv_wording]', pref_inv_detail_heading = '$_POST[pref_inv_detail_heading]', pref_inv_detail_line = '$_POST[pref_inv_detail_line]', pref_inv_payment_method = '$_POST[pref_inv_payment_method]', pref_inv_payment_line1_name = '$_POST[pref_inv_payment_line1_name]', pref_inv_payment_line1_value = '$_POST[pref_inv_payment_line1_value]', pref_inv_payment_line2_name = '$_POST[pref_inv_payment_line2_name]',pref_inv_payment_line2_value = '$_POST[pref_inv_payment_line2_value]', pref_enabled = '$_POST[pref_enabled]'    WHERE  pref_id = '$_GET[submit]'";
                if (mysql_query($sql, $conn)) {
...
$default_payment_type = $_POST['def_payment_type'];
	...
	if ($_GET[sys_default] == "line_items") {
		...
		$sql = "REPLACE INTO si_defaults VALUES (1,$def_billerField,$def_customerField,$def_taxField,$def_inv_preferenceField,$default_num_line_items,'$def_inv_templateField',$def_payment_typeField)";
	...
	#UPDATE the default invoice template field
		...
		$sql = "REPLACE INTO si_defaults VALUES (1,$def_billerField,$def_customerField,$def_taxField,$def_inv_preferenceField,$def_number_line_itemsField,'$def_inv_template',$def_payment_typeField)";
 ...
 ";
	...
	header( 'refresh: 2; url=system_default_details.php' );
        ...
        #UPDATE the default biller field
                ...
                $sql = "REPLACE INTO si_defaults VALUES (1,$default_biller,$def_customerField,$def_taxField,$def_inv_preferenceField,$def_number_line_itemsField,'$def_inv_templateField','$def_payment_typeField')";
...
<br>(1,$def_customerField,$def_billerField,$def_taxField,$def_inv_preferenceField,$def_number_line_itemsField,$def_inv_template)
 ";
        ...
        #UPDATE the default customer field
                ...
                $sql = "REPLACE INTO si_defaults VALUES (1,$def_billerField,$default_customer,$def_taxField,$def_inv_preferenceField,$def_number_line_itemsField,'$def_inv_templateField',$def_payment_typeField)";
...
<br>(1,$def_customerField,$def_billerField,$def_taxField,$def_inv_preferenceField,$def_number_line_itemsField,$def_inv_template)
 ";
        ...
        #UPDATE the default tax field
                ...
                $sql = "REPLACE INTO si_defaults VALUES (1,$def_billerField,$def_customerField,$default_tax,$def_inv_preferenceField,$def_number_line_itemsField,'$def_inv_templateField',$def_payment_typeField)";
...
<br>(1,$def_customerField,$def_billerField,$def_taxField,$def_inv_preferenceField,$def_number_line_itemsField,$def_inv_template)
 ";
        ...
        #UPDATE the default invoice preference field
                ...
                $sql = "REPLACE INTO si_defaults VALUES (1,$def_billerField,$def_customerField,$def_taxField,$default_inv_preference,$def_number_line_itemsField,'$def_inv_templateField','$def_payment_typeField')";
...
<br>(1,$def_customerField,$def_billerField,$def_taxField,$def_inv_preferenceField,$def_number_line_itemsField,$def_inv_template)
 ";
        ...
        #UPDATE the default payment_type field
                ...
                $sql = "REPLACE INTO si_defaults VALUES (1,$def_billerField,$def_customerField,$def_taxField,$def_inv_preferenceField,$def_number_line_itemsField,'$def_inv_templateField',$default_payment_type)";
...
#insert invoice_total
	...
	$sql = "INSERT into si_invoices values ('','$_POST[sel_id]','$_POST[select_customer]','1','$_POST[select_preferences]',now(),'$_POST[invoice_total_note]')";
	...
	$sql_items = "INSERT into si_invoice_items values ('',$invoice_id,'1','00','00','$_POST[select_tax]',$tax_percentageField,$total_invoice_total_tax ,'$_POST[inv_it_gross_total]','$_POST[i_description]',$total_invoice_total)";
...
#EDIT invoice_total
	...
	echo "$invoice_id <br><br>";

        $sql = "REPLACE into si_invoices values ('','$_POST[sel_id]','$_POST[select_customer]','1','$_POST[select_preferences]',now(),'$_POST[invoice_total_note]') where inv_id = $invoice_id"; 
        if (mysql_query($sql)) {
                $display_block =  "Processing invoice, <br> you will be redirected Quick View of this invoice";
        } else {
                $display_block =  "Something went wrong, please try adding the invoice again"; }
...
*/
        ...
        $sql_items = "UPDATE si_invoice_items set inv_it_description = '$_POST[i_description]', inv_it_gross_total = '$_POST[inv_it_gross_total]' WHERE inv_it_invoice_id = $invoice_id";
       /*

        $sql_items = "UPDATE si_invoice_items set inv_it_description = '$_POST[i_description] and inv_it_gross_total = '$_POST[inv_it_gross_total]' WHERE  inv_it_invoice_id =a '$_POST[invoice_id]'";
$sql_items = "REPLACE into si_invoice_items values ('',$invoice_id,'1','00','00','$_POST[select_tax]',$tax_percentageField,$total_invoice_total_tax ,'$_POST[inv_it_gross_total]','$_POST[i_description]',$total_invoice_total)"; */
...
#INVOICE CONSULTING
	...
	$sql = "INSERT into si_invoices values ('','$_POST[sel_id]','$_POST[select_customer]', 3,'$_POST[select_preferences]',now(),'$_POST[invoice_total_note]')";
