<?php
	...
	$patch['1']['patch'] = "CREATE TABLE ".TB_PREFIX."sql_patchmanager (sql_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,sql_patch_ref VARCHAR( 50 ) NOT NULL ,sql_patch VARCHAR( 50 ) NOT NULL ,sql_release VARCHAR( 25 ) NOT NULL ,sql_statement TEXT NOT NULL) TYPE = MYISAM)";
...
";
        ...
        $patch['32']['patch'] = "
	ALTER TABLE `".TB_PREFIX."products` ADD `prod_custom_field1` VARCHAR( 50 ) AFTER `prod_unit_price` ,
	...
	";
        ...
        $patch['33']['patch'] = "
		UPDATE `".TB_PREFIX."custom_fields` SET `cf_custom_field` = 'product_cf4' WHERE `".TB_PREFIX."custom_fields`.`cf_id` =12 LIMIT 1 ;
        ";
        $patch['33']['date'] = "20061214";

        $patch['34']['name'] = "Reset invoice template to default refer Issue 70";
        $patch['34']['patch'] = "
		UPDATE `".TB_PREFIX."defaults` SET `def_inv_template` = 'default' WHERE `def_id` =1 LIMIT 1 ;
        ";
...
";
        ...
        $patch['36']['patch'] = "
        ALTER TABLE `".TB_PREFIX."invoices` ADD `invoice_custom_field1` VARCHAR( 50 ) AFTER `inv_date` ,
        ...
        $patch['38']['patch'] = "
		ALTER TABLE `".TB_PREFIX."custom_fields` CHANGE `cf_custom_field` `cf_custom_field` VARCHAR( 255 )
        ";
        $patch['38']['date'] = "20070523";
        
        $patch['39']['name'] = "Alter custom field table - field length now 255 for field label";
        $patch['39']['patch'] = "
		ALTER TABLE `".TB_PREFIX."custom_fields` CHANGE `cf_custom_label` `cf_custom_label` VARCHAR( 255 )
        ";
        $patch['39']['date'] = "20070523";


        $patch['40']['name'] = "Alter field name in ".TB_PREFIX."partchmanager";
  ...
  UNIQUE KEY `name` (`name`)
	...
	$patch['63']['patch'] = "INSERT INTO `".TB_PREFIX."system_defaults` (`id`, `name`, `value`) VALUES 
(1, 'biller', '4'),
(2, 'customer', '3'),
(3, 'tax', '1'),
(4, 'preference', '1'),
...
";
	...
	$patch['115']['patch'] = "INSERT INTO `".TB_PREFIX."system_defaults` ( `id` , `name` , `value` ) 
VALUES (
NULL , 'logging', '0'
);";
	...
	$patch['129']['patch'] = "INSERT INTO `".TB_PREFIX."users` (`user_id`, `user_email`, `user_name`, `user_group`, `user_domain`, `user_password`) VALUES (NULL, 'demo@simpleinvoices.org', 'guest', '1', '1', MD5('demo'))";
...
// Uncomment Patches 139-140 only if you are continuing with this version and not proceeding to trunk version
//    $patch['139']['name'] = "Correct Foreign Key Tax ID Field Type in Invoice Items Table";
//    $patch['139']['patch'] = "ALTER TABLE  `".TB_PREFIX."invoice_items` CHANGE `tax_id` `tax_id` int  DEFAULT '0' NOT NULL ;";
...
/*
	...
	$patch['123']['patch'] = "CREATE TABLE `".TB_PREFIX."menu` (
...
`link` VARCHAR( 100 ) NOT NULL ,
 `enabled` tinyint(1) NOT NULL default '1'
	...
	$patch['124']['patch'] = 'INSERT INTO `".TB_PREFIX."menu` (`id`, `parentid`, `order`, `name`, `link`, `enabled`) VALUES 
...
(34, 20, 35, "{$LANG[\"debtors\"]} +", "index.php?module=reports&view=report_debtors_by_amount", 1),
(35, 34, 1, "{$LANG[\"debtors_by_amount_owed\"]}", "index.php?module=reports&view=report_debtors_by_amount", 1),
(36, 34, 2, "{$LANG[\"debtors_by_aging_periods\"]}", "index.php?module=reports&view=report_debtors_by_aging", 1),
(37, 34, 3, "{$LANG[\"total_owed_per_customer\"]}", "index.php?module=reports&view=report_debtors_owing_by_customer", 1),
...
(68, 40, 14, "Manage Custom Fields 2", "index.php?module=customFields&view=manageCustomFields", 1);';
	...
	$patch['131']['name'] = "Create ".TB_PREFIX."customFieldCategories table";
	$patch['131']['patch'] = "CREATE TABLE `".TB_PREFIX."customFieldCategories` (
  `id` int(11) NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`) );";
	...
	$patch['132']['name'] = "Insert ".TB_PREFIX."customFieldCategories default values";
	$patch['132']['patch'] = "INSERT INTO `".TB_PREFIX."customFieldCategories` (`id`, `name`) VALUES 
(1, 'biller'),
(2, 'customer'),
(3, 'product'),
(4, 'invoice');";
	...
	$patch['133']['name'] = "Create ".TB_PREFIX."customFieldValues table";
	$patch['133']['patch'] = "CREATE TABLE `".TB_PREFIX."customFieldValues` (
  `id` int(11) NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`));";
	...
	$patch['134']['name'] = "Create ".TB_PREFIX."customFields table";
	$patch['134']['patch'] = "CREATE TABLE `".TB_PREFIX."customFields` (
  `id` int(11) NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`)
	...
	*/
//ADD THE ABOVE PATCHES BACK IN AFTER THE SEPT 07 RELEASE
