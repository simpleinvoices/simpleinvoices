...
if ($_GET['action'] == "view") {
 ...
 <hr></hr>
	...
	<tr>
		<td class="details_screen">{$LANG_street2} <a href="./documentation/text/street2.html?keepThis=true&TB_iframe=true&height=300&width=500" title="Info :: Street address 2" class="thickbox"><img src="./images/common/help-small.png"></img></a></td><td>{$b_street_address2Field}</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="details_screen">{$biller_custom_field_label1} <a href="./documentation/text/custom_fields.html?keepThis=true&TB_iframe=true&height=300&width=500" title="Info :: Custom fields" class="thickbox"><img src="./images/common/help-small.png"></img></a></td>
		<td>{$b_custom_field1Field}</td>
	</tr>
	<tr>
		<td class="details_screen">{$biller_custom_field_label2} <a href="./documentation/text/custom_fields.html?keepThis=true&TB_iframe=true&height=300&width=500" title="Info :: Custom fields" class="thickbox"><img src="./images/common/help-small.png"></img></a></td>
		<td>{$b_custom_field2Field}</td>
	</tr>
	<tr>
		<td class="details_screen">{$biller_custom_field_label3} <a href="./documentation/text/custom_fields.html?keepThis=true&TB_iframe=true&height=300&width=500" title="Info :: Custom fields" class="thickbox"><img src="./images/common/help-small.png"></img></a></td>
		<td>{$b_custom_field3Field}</td>
	</tr>
	<tr>
		<td class="details_screen">{$biller_custom_field_label4} <a href="./documentation/text/custom_fields.html?keepThis=true&TB_iframe=true&height=300&width=500" title="Info :: Custom fields" class="thickbox"><img src="./images/common/help-small.png"></img></a></td>
		<td>{$b_custom_field4Field}</td>
	</tr>
	<tr>
		<td class="details_screen">{$LANG_logo_file} <a href="documentation/text/insert_biller_text.html?keepThis=true&TB_iframe=true&height=300&width=500" title="Info :: Logo file" class="thickbox"><img src="./images/common/help-small.png"></img></a></td><td>{$b_co_logoField}</td>
	</tr>	
	<tr>
...
$display_block = <<<EOD
 ...
 <hr></hr>
	...
	<tr>
		<td class="details_screen">{$LANG_street2} <a href="./documentation/text/street2.html?keepThis=true&TB_iframe=true&height=300&width=500" title="Info :: Street address 2" class="thickbox"><img src="./images/common/help-small.png"></img></a></td>
	...
	<tr>
		...
		<a href="documentation/text/insert_biller_text.html?keepThis=true&TB_iframe=true&height=300&width=500" title="Info :: Logo file" class="thickbox"><img src="./images/common/help-small.png"></img></a></td>
