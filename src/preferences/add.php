...
<table align=center>
<tr>
	<td class="details_screen">{$LANG_description} <a href="src/documentation/info_pages/inv_pref_description.html" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td>
	<td><input type=text name="p_description" size=25></td>
</tr>
<tr>
	<td class="details_screen">{$LANG_currency_sign} <a href="src/documentation/info_pages/inv_pref_currency_sign.html" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td>
	<td><input type=text name="p_currency_sign" size=25></td>
</tr>
<tr>
	<td class="details_screen">{$LANG_invoice_heading} <a href="src/documentation/info_pages/inv_pref_invoice_heading.html" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td>
