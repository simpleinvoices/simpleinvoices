...
$display_block_top =  "
	...
	<tr>
		...
		<td class=account>$LANG_age <a href='documentation/text/age.html?keepThis=true&TB_iframe=true&height=300&width=500' title='Info :: Invoice age' class='thickbox'>*</a> :</td><td class=account nowrap >$invoice_age</td>
		<td></td><td></td>
