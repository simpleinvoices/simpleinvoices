...
class Background {
     ...
     */
    public function __construct($color, $image, $repeat, $position) {
        $this->_color = $color;
        $this->_image = $image;
        $this->_repeat = $repeat;
    ...
    public function copy() {
        $value = new Background($this->_color->copy(), $this->_image->copy(), $this->_repeat, $this->_position->copy());
        return $value;
    }
    ...
    public function is_default() {
        return $this->_color->equals(CSSBackgroundColor::default_value()) && $this->_image->is_default() &&
               $this->_repeat == CSSBackgroundRepeat::default_value() && $this->_position->is_default();
    }
     ...
     * @uses OutputDriver
     */
    public function show(&$driver, &$box) {
        /**
