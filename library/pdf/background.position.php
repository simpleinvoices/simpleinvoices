 ...
 *
 * @link http://www.w3.org/TR/CSS21/colors.html#propdef-background-position CSS 2.1 'background-position' property
 *       description
 */
class BackgroundPosition {
     ...
     */
    public function __construct($x, $x_percentage, $y, $y_percentage) {
        $this->x = $x;
    ...
    public function &copy() {
        $value = new BackgroundPosition($this->x, $this->x_percentage, $this->y, $this->y_percentage);
        return $value;
    }
    ...
    public function is_default() {
        return $this->x == 0 && $this->x_percentage && $this->y == 0 && $this->y_percentage;
    }
