...
hero:
  ...
  tagline: Create and manage invoices, clients, and payments - web-based invoicing <mark style="background:#fef08a;padding:0 4px;border-radius:3px;">on your own server</mark>
  image:
