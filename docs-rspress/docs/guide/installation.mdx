...
Simple Invoices is a web-based invoice management system: free, open-source, and self-hosted. It lets you create, manage, and send invoices from any device with a browser. Which you can install and run on your own server.

Simple Invoices can be installed in multiple ways. Choose the one that fits your setup.
