...
if (  $op === 'insert_preference' ) {
    ...
    if (dbQuery($sql, ':domain_id'             , $auth_session->domain_id,
                      ...
                      ':index_group'           , empty($_POST['index_group']) ?
                                                    lastInsertId() :
                                                    $_POST['index_group'],
        ...
        if (empty($_POST['index_group'])) {
            $sql_update = "UPDATE ".TB_PREFIX."preferences
                           SET index_group = :index_group
    ...
    if (isset($_POST['save_preference'])) {
        $sql = "UPDATE " . TB_PREFIX . "preferences
                SET pref_description             = :description,
                    ...
                    include_online_payment       = :include_online_payment
                WHERE pref_id = :id";
        if (dbQuery($sql, ':description'           , $_POST['pref_description'],
