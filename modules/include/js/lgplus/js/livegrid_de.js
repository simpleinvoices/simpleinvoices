...
RicoTranslate.addPhrase("Show All","zeigen Sie alle")
RicoTranslate.addPhrase("Ascending","aufsteigend")
RicoTranslate.addPhrase("Descending","absteigend")

RicoTranslate.addPhrase("Include only this value","nur diesen Wert hinzufügen")
RicoTranslate.addPhrase("Exclude this value","diesen Wert ausschliessen")
RicoTranslate.addPhrase("Greater than or equal to this value","grösser oder gleich diesem Wert")
...
RicoTranslate.addPhrase("Enter keyword to search for","Schlüsselwort eintragen, um danach zu suchen ")
RicoTranslate.addPhrase("use * as a wildcard","Verwende * als Wildcard ")
RicoTranslate.addPhrase("also","also")
RicoTranslate.addPhrase("Remove filter","entferne Filter")

RicoTranslate.addPhrase("Waiting for data","warten auf Daten")
RicoTranslate.addPhrase("Request for data timed out","Zeitüberschreitung")

RicoTranslate.addPhrase("No matching records","Keine übereinstimmenden Datensätze")
RicoTranslate.addPhrase("Listing records","Datensätze auflisten")
RicoTranslate.addPhrase("of","von")
RicoTranslate.addPhrase("of about","von ungefähr")

RicoTranslate.monthNames=["Jänner", "Februar", "März", "April", "Mai","Juni", "Juli", "August", "September", "Oktober", "November", "Dzember"]
...
RicoTranslate.addPhrase("Visible rows","Sichtbare reihen")
RicoTranslate.addPhrase("All rows","Alle reihen")

// for demo only:

RicoTranslate.addPhrase("Show orders for","Zeige Bestellungen für")
RicoTranslate.addPhrase("Show order detail","Zeige Bestelldetail")
