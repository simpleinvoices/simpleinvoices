...
*/
	...
	<a title='".$LANG['export_tooltip']." ".$row['preference']." ".$row['id']."' class='index_table' href='index.php?module=export&view=payment&id=$row[id]&format=pdf'><img src='images/common/page_white_acrobat.png' class='action' /></a>
	]]></cell>";
