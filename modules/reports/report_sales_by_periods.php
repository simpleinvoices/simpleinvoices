...
while ( $year <= $this_year ){
	...
	while ($month <= 12){
		...
		$total_month_sales_sql = "
			...
			";
		$total_month_sales = $db->query($total_month_sales_sql, ':domain_id', $auth_session->domain_id);
		...
		$total_month_payments = $db->query($total_month_payments_sql, ':domain_id', $auth_session->domain_id);
	...
	$total_year_sales_sql = "
		...
		";
	$total_year_sales = $db->query($total_year_sales_sql, ':domain_id', $auth_session->domain_id);
	...
	$total_year_payments = $db->query($total_year_payments_sql, ':domain_id', $auth_session->domain_id);
