...
foreach($invoices as $k=>$v)
{
    ...
    $sth = dbQuery($sql, ':id',$v['id'], ':domain_id', domain_id::get());
    ...
    foreach($products as $pk=>$pv)
    {
        ...
        $sthp = dbQuery($sqlp, ':product_id',$pv['product_id'], ':invoice_id',$v['id'], ':domain_id', domain_id::get());
        ...
        $sthp = dbQuery($sqlc, ':product_id',$pv['product_id'], ':domain_id', domain_id::get());
