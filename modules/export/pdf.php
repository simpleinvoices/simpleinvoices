...
$url_pdf_encoded = urlencode($url_pdf);
	$logger->log('Invoice ID: '.$invoice_id.' Get ID: '.$_GET['id'] , LegacyLogger::INFO);
	$logger->log('PDF: '.$url_pdf, LegacyLogger::INFO);
	$logger->log('PDF url: '.$url_pdf_encoded, LegacyLogger::INFO);
