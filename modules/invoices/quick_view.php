...
<!-- #PDF end -->
	...
	<tr>
		...
		<td class=account><a href='index.php?module=payments&view=manage&id=$customer[id]'>{$LANG['paid']}:</a></td><td class=account>$preference[pref_currency_sign]$invoice[paid_format]</td>
		<td class=account>{$LANG['owing']}:</td><td class=account><u>$preference[pref_currency_sign]$invoice[owing]</u></td>
	</tr>
	</table>
