...
//echo sql2xml($invoices, $count);
	...
	foreach ($invoices as $row) {
		...
		<!--6 Payment --><a title='".$LANG['process_payment']." ".$invoice['preference']['pref_inv_wording']." ".$row['id']."' class='index_table' href='index.php?module=payments&view=process&id=".$row['id']."&op=pay_selected_invoice'><img src='images/common/money_dollar.png' height='16' border='0' padding='-4px' valign='bottom' /></a>
		<!--7 Email --><a title='".$LANG['email']." ".$invoice['preference']['pref_inv_wording']." ".$row['id']."' class='index_table' href='index.php?module=invoices&view=email&stage=1&id=".$row['id']."'><img src='images/common/mail-message-new.png' height='16' border='0' padding='-4px' valign='bottom' /></a>
					]]>
				</cell>";
